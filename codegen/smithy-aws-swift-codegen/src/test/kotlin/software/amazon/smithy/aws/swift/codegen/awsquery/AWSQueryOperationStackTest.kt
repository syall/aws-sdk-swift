...
extension QueryProtocolClient: QueryProtocolClientProtocol {
    ...
    public func noInputAndOutput(input: NoInputAndOutputInput) async throws -> NoInputAndOutputOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<QueryProtocolAuthSchemeResolver, NoInputAndOutputOutput, NoInputAndOutputOutputError>())
