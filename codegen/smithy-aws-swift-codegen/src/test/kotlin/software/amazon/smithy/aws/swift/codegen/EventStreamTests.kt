...
extension EventStreamTestClient: EventStreamTestClientProtocol {
    ...
    public func testStreamOp(input: TestStreamOpInput) async throws -> TestStreamOpOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EventStreamTestAuthSchemeResolver, TestStreamOpOutput, TestStreamOpOutputError>())
