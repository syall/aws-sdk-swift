...
public struct RDSAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol RDSAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultRDSAuthSchemeResolver: RDSAuthSchemeResolver {
    public typealias Parameters = RDSAuthSchemeResolverParameters
