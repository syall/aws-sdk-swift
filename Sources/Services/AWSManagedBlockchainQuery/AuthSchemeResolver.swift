...
public struct ManagedBlockchainQueryAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol ManagedBlockchainQueryAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultManagedBlockchainQueryAuthSchemeResolver: ManagedBlockchainQueryAuthSchemeResolver {
    public typealias Parameters = ManagedBlockchainQueryAuthSchemeResolverParameters
    ...
    public func resolveAuthScheme(params: Parameters) throws -> [AuthOption] {
        ...
        switch params.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: AttributeKeys.signingName, value: "managedblockchain-query")
