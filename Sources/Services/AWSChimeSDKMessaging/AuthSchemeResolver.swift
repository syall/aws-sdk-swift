...
public struct ChimeSDKMessagingAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol ChimeSDKMessagingAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultChimeSDKMessagingAuthSchemeResolver: ChimeSDKMessagingAuthSchemeResolver {
    public typealias Parameters = ChimeSDKMessagingAuthSchemeResolverParameters
