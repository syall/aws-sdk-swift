...
public struct ConnectParticipantAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol ConnectParticipantAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultConnectParticipantAuthSchemeResolver: ConnectParticipantAuthSchemeResolver {
    public typealias Parameters = ConnectParticipantAuthSchemeResolverParameters
