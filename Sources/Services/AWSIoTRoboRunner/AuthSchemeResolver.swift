...
public struct IoTRoboRunnerAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol IoTRoboRunnerAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service IoTRoboRunner must conform to.
}

public struct DefaultIoTRoboRunnerAuthSchemeResolver: IoTRoboRunnerAuthSchemeResolver {
    public typealias Parameters = IoTRoboRunnerAuthSchemeResolverParameters
    ...
    public func resolveAuthScheme(params: Parameters) throws -> [AuthOption] {
        ...
        switch params.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: AttributeKeys.signingName, value: "iotroborunner")
    ...
    public func constructParameters(context: HttpContext) throws -> Parameters {
        ...
        return IoTRoboRunnerAuthSchemeResolverParameters(operation: opName, region: opRegion)
    }
}
