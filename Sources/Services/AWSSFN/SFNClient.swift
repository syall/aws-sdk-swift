...
extension SFNClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any SFNAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any SFNAuthSchemeResolver)? = nil) throws {
...
extension SFNClient: SFNClientProtocol {
    ...
    public func createActivity(input: CreateActivityInput) async throws -> CreateActivityOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, CreateActivityOutput, CreateActivityOutputError>())
    ...
    public func createStateMachine(input: CreateStateMachineInput) async throws -> CreateStateMachineOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, CreateStateMachineOutput, CreateStateMachineOutputError>())
    ...
    public func createStateMachineAlias(input: CreateStateMachineAliasInput) async throws -> CreateStateMachineAliasOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, CreateStateMachineAliasOutput, CreateStateMachineAliasOutputError>())
    ...
    public func deleteActivity(input: DeleteActivityInput) async throws -> DeleteActivityOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, DeleteActivityOutput, DeleteActivityOutputError>())
    ...
    public func deleteStateMachine(input: DeleteStateMachineInput) async throws -> DeleteStateMachineOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, DeleteStateMachineOutput, DeleteStateMachineOutputError>())
    ...
    public func deleteStateMachineAlias(input: DeleteStateMachineAliasInput) async throws -> DeleteStateMachineAliasOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, DeleteStateMachineAliasOutput, DeleteStateMachineAliasOutputError>())
    ...
    public func deleteStateMachineVersion(input: DeleteStateMachineVersionInput) async throws -> DeleteStateMachineVersionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, DeleteStateMachineVersionOutput, DeleteStateMachineVersionOutputError>())
    ...
    public func describeActivity(input: DescribeActivityInput) async throws -> DescribeActivityOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, DescribeActivityOutput, DescribeActivityOutputError>())
    ...
    public func describeExecution(input: DescribeExecutionInput) async throws -> DescribeExecutionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, DescribeExecutionOutput, DescribeExecutionOutputError>())
    ...
    public func describeMapRun(input: DescribeMapRunInput) async throws -> DescribeMapRunOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, DescribeMapRunOutput, DescribeMapRunOutputError>())
    ...
    public func describeStateMachine(input: DescribeStateMachineInput) async throws -> DescribeStateMachineOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, DescribeStateMachineOutput, DescribeStateMachineOutputError>())
    ...
    public func describeStateMachineAlias(input: DescribeStateMachineAliasInput) async throws -> DescribeStateMachineAliasOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, DescribeStateMachineAliasOutput, DescribeStateMachineAliasOutputError>())
    ...
    public func describeStateMachineForExecution(input: DescribeStateMachineForExecutionInput) async throws -> DescribeStateMachineForExecutionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, DescribeStateMachineForExecutionOutput, DescribeStateMachineForExecutionOutputError>())
    ...
    public func getActivityTask(input: GetActivityTaskInput) async throws -> GetActivityTaskOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, GetActivityTaskOutput, GetActivityTaskOutputError>())
    ...
    public func getExecutionHistory(input: GetExecutionHistoryInput) async throws -> GetExecutionHistoryOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, GetExecutionHistoryOutput, GetExecutionHistoryOutputError>())
    ...
    public func listActivities(input: ListActivitiesInput) async throws -> ListActivitiesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, ListActivitiesOutput, ListActivitiesOutputError>())
    ...
    public func listExecutions(input: ListExecutionsInput) async throws -> ListExecutionsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, ListExecutionsOutput, ListExecutionsOutputError>())
    ...
    public func listMapRuns(input: ListMapRunsInput) async throws -> ListMapRunsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, ListMapRunsOutput, ListMapRunsOutputError>())
    ...
    public func listStateMachineAliases(input: ListStateMachineAliasesInput) async throws -> ListStateMachineAliasesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, ListStateMachineAliasesOutput, ListStateMachineAliasesOutputError>())
    ...
    public func listStateMachineVersions(input: ListStateMachineVersionsInput) async throws -> ListStateMachineVersionsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, ListStateMachineVersionsOutput, ListStateMachineVersionsOutputError>())
    ...
    public func listStateMachines(input: ListStateMachinesInput) async throws -> ListStateMachinesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, ListStateMachinesOutput, ListStateMachinesOutputError>())
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, ListTagsForResourceOutput, ListTagsForResourceOutputError>())
    ...
    public func publishStateMachineVersion(input: PublishStateMachineVersionInput) async throws -> PublishStateMachineVersionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, PublishStateMachineVersionOutput, PublishStateMachineVersionOutputError>())
    ...
    public func sendTaskFailure(input: SendTaskFailureInput) async throws -> SendTaskFailureOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, SendTaskFailureOutput, SendTaskFailureOutputError>())
    ...
    public func sendTaskHeartbeat(input: SendTaskHeartbeatInput) async throws -> SendTaskHeartbeatOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, SendTaskHeartbeatOutput, SendTaskHeartbeatOutputError>())
    ...
    public func sendTaskSuccess(input: SendTaskSuccessInput) async throws -> SendTaskSuccessOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, SendTaskSuccessOutput, SendTaskSuccessOutputError>())
    ...
    public func startExecution(input: StartExecutionInput) async throws -> StartExecutionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, StartExecutionOutput, StartExecutionOutputError>())
    ...
    public func startSyncExecution(input: StartSyncExecutionInput) async throws -> StartSyncExecutionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, StartSyncExecutionOutput, StartSyncExecutionOutputError>())
    ...
    public func stopExecution(input: StopExecutionInput) async throws -> StopExecutionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, StopExecutionOutput, StopExecutionOutputError>())
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, TagResourceOutput, TagResourceOutputError>())
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, UntagResourceOutput, UntagResourceOutputError>())
    ...
    public func updateMapRun(input: UpdateMapRunInput) async throws -> UpdateMapRunOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, UpdateMapRunOutput, UpdateMapRunOutputError>())
    ...
    public func updateStateMachine(input: UpdateStateMachineInput) async throws -> UpdateStateMachineOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, UpdateStateMachineOutput, UpdateStateMachineOutputError>())
    ...
    public func updateStateMachineAlias(input: UpdateStateMachineAliasInput) async throws -> UpdateStateMachineAliasOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SFNAuthSchemeResolver, UpdateStateMachineAliasOutput, UpdateStateMachineAliasOutputError>())
