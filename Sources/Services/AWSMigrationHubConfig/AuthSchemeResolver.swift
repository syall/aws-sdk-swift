...
public struct MigrationHubConfigAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol MigrationHubConfigAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultMigrationHubConfigAuthSchemeResolver: MigrationHubConfigAuthSchemeResolver {
    public typealias Parameters = MigrationHubConfigAuthSchemeResolverParameters
