...
public struct S3ControlAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol S3ControlAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultS3ControlAuthSchemeResolver: S3ControlAuthSchemeResolver {
    public typealias Parameters = S3ControlAuthSchemeResolverParameters
