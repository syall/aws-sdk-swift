...
extension KinesisVideoArchivedMediaClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any KinesisVideoArchivedMediaAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any KinesisVideoArchivedMediaAuthSchemeResolver)? = nil) throws {
...
extension KinesisVideoArchivedMediaClient: KinesisVideoArchivedMediaClientProtocol {
    ...
    public func getClip(input: GetClipInput) async throws -> GetClipOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<KinesisVideoArchivedMediaAuthSchemeResolver, GetClipOutput, GetClipOutputError>())
    ...
    public func getDASHStreamingSessionURL(input: GetDASHStreamingSessionURLInput) async throws -> GetDASHStreamingSessionURLOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<KinesisVideoArchivedMediaAuthSchemeResolver, GetDASHStreamingSessionURLOutput, GetDASHStreamingSessionURLOutputError>())
    ...
    public func getHLSStreamingSessionURL(input: GetHLSStreamingSessionURLInput) async throws -> GetHLSStreamingSessionURLOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<KinesisVideoArchivedMediaAuthSchemeResolver, GetHLSStreamingSessionURLOutput, GetHLSStreamingSessionURLOutputError>())
    ...
    public func getImages(input: GetImagesInput) async throws -> GetImagesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<KinesisVideoArchivedMediaAuthSchemeResolver, GetImagesOutput, GetImagesOutputError>())
    ...
    public func getMediaForFragmentList(input: GetMediaForFragmentListInput) async throws -> GetMediaForFragmentListOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<KinesisVideoArchivedMediaAuthSchemeResolver, GetMediaForFragmentListOutput, GetMediaForFragmentListOutputError>())
    ...
    public func listFragments(input: ListFragmentsInput) async throws -> ListFragmentsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<KinesisVideoArchivedMediaAuthSchemeResolver, ListFragmentsOutput, ListFragmentsOutputError>())
