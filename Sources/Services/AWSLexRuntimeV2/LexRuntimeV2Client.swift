...
extension LexRuntimeV2Client {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any LexRuntimeV2AuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any LexRuntimeV2AuthSchemeResolver)? = nil) throws {
...
extension LexRuntimeV2Client: LexRuntimeV2ClientProtocol {
    ...
    public func deleteSession(input: DeleteSessionInput) async throws -> DeleteSessionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexRuntimeV2AuthSchemeResolver, DeleteSessionOutput, DeleteSessionOutputError>())
    ...
    public func getSession(input: GetSessionInput) async throws -> GetSessionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexRuntimeV2AuthSchemeResolver, GetSessionOutput, GetSessionOutputError>())
    ...
    public func putSession(input: PutSessionInput) async throws -> PutSessionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexRuntimeV2AuthSchemeResolver, PutSessionOutput, PutSessionOutputError>())
    ...
    public func recognizeText(input: RecognizeTextInput) async throws -> RecognizeTextOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexRuntimeV2AuthSchemeResolver, RecognizeTextOutput, RecognizeTextOutputError>())
    ...
    public func recognizeUtterance(input: RecognizeUtteranceInput) async throws -> RecognizeUtteranceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexRuntimeV2AuthSchemeResolver, RecognizeUtteranceOutput, RecognizeUtteranceOutputError>())
    ...
    public func startConversation(input: StartConversationInput) async throws -> StartConversationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexRuntimeV2AuthSchemeResolver, StartConversationOutput, StartConversationOutputError>())
