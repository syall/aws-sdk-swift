...
public struct LexRuntimeV2AuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol LexRuntimeV2AuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultLexRuntimeV2AuthSchemeResolver: LexRuntimeV2AuthSchemeResolver {
    public typealias Parameters = LexRuntimeV2AuthSchemeResolverParameters
