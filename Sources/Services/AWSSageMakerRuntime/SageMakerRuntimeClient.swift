...
extension SageMakerRuntimeClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any SageMakerRuntimeAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any SageMakerRuntimeAuthSchemeResolver)? = nil) throws {
...
extension SageMakerRuntimeClient: SageMakerRuntimeClientProtocol {
    ...
    public func invokeEndpoint(input: InvokeEndpointInput) async throws -> InvokeEndpointOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SageMakerRuntimeAuthSchemeResolver, InvokeEndpointOutput, InvokeEndpointOutputError>())
    ...
    public func invokeEndpointAsync(input: InvokeEndpointAsyncInput) async throws -> InvokeEndpointAsyncOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SageMakerRuntimeAuthSchemeResolver, InvokeEndpointAsyncOutput, InvokeEndpointAsyncOutputError>())
    ...
    public func invokeEndpointWithResponseStream(input: InvokeEndpointWithResponseStreamInput) async throws -> InvokeEndpointWithResponseStreamOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SageMakerRuntimeAuthSchemeResolver, InvokeEndpointWithResponseStreamOutput, InvokeEndpointWithResponseStreamOutputError>())
