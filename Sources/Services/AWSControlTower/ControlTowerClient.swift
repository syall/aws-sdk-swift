...
extension ControlTowerClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any ControlTowerAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any ControlTowerAuthSchemeResolver)? = nil) throws {
...
extension ControlTowerClient: ControlTowerClientProtocol {
    ...
    public func disableControl(input: DisableControlInput) async throws -> DisableControlOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ControlTowerAuthSchemeResolver, DisableControlOutput, DisableControlOutputError>())
    ...
    public func enableControl(input: EnableControlInput) async throws -> EnableControlOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ControlTowerAuthSchemeResolver, EnableControlOutput, EnableControlOutputError>())
    ...
    public func getControlOperation(input: GetControlOperationInput) async throws -> GetControlOperationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ControlTowerAuthSchemeResolver, GetControlOperationOutput, GetControlOperationOutputError>())
    ...
    public func listEnabledControls(input: ListEnabledControlsInput) async throws -> ListEnabledControlsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ControlTowerAuthSchemeResolver, ListEnabledControlsOutput, ListEnabledControlsOutputError>())
