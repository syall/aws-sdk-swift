...
extension ElasticTranscoderClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any ElasticTranscoderAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any ElasticTranscoderAuthSchemeResolver)? = nil) throws {
...
extension ElasticTranscoderClient: ElasticTranscoderClientProtocol {
    ...
    public func cancelJob(input: CancelJobInput) async throws -> CancelJobOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, CancelJobOutput, CancelJobOutputError>())
    ...
    public func createJob(input: CreateJobInput) async throws -> CreateJobOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, CreateJobOutput, CreateJobOutputError>())
    ...
    public func createPipeline(input: CreatePipelineInput) async throws -> CreatePipelineOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, CreatePipelineOutput, CreatePipelineOutputError>())
    ...
    public func createPreset(input: CreatePresetInput) async throws -> CreatePresetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, CreatePresetOutput, CreatePresetOutputError>())
    ...
    public func deletePipeline(input: DeletePipelineInput) async throws -> DeletePipelineOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, DeletePipelineOutput, DeletePipelineOutputError>())
    ...
    public func deletePreset(input: DeletePresetInput) async throws -> DeletePresetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, DeletePresetOutput, DeletePresetOutputError>())
    ...
    public func listJobsByPipeline(input: ListJobsByPipelineInput) async throws -> ListJobsByPipelineOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, ListJobsByPipelineOutput, ListJobsByPipelineOutputError>())
    ...
    public func listJobsByStatus(input: ListJobsByStatusInput) async throws -> ListJobsByStatusOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, ListJobsByStatusOutput, ListJobsByStatusOutputError>())
    ...
    public func listPipelines(input: ListPipelinesInput) async throws -> ListPipelinesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, ListPipelinesOutput, ListPipelinesOutputError>())
    ...
    public func listPresets(input: ListPresetsInput) async throws -> ListPresetsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, ListPresetsOutput, ListPresetsOutputError>())
    ...
    public func readJob(input: ReadJobInput) async throws -> ReadJobOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, ReadJobOutput, ReadJobOutputError>())
    ...
    public func readPipeline(input: ReadPipelineInput) async throws -> ReadPipelineOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, ReadPipelineOutput, ReadPipelineOutputError>())
    ...
    public func readPreset(input: ReadPresetInput) async throws -> ReadPresetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, ReadPresetOutput, ReadPresetOutputError>())
    ...
    public func testRole(input: TestRoleInput) async throws -> TestRoleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, TestRoleOutput, TestRoleOutputError>())
    ...
    public func updatePipeline(input: UpdatePipelineInput) async throws -> UpdatePipelineOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, UpdatePipelineOutput, UpdatePipelineOutputError>())
    ...
    public func updatePipelineNotifications(input: UpdatePipelineNotificationsInput) async throws -> UpdatePipelineNotificationsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, UpdatePipelineNotificationsOutput, UpdatePipelineNotificationsOutputError>())
    ...
    public func updatePipelineStatus(input: UpdatePipelineStatusInput) async throws -> UpdatePipelineStatusOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ElasticTranscoderAuthSchemeResolver, UpdatePipelineStatusOutput, UpdatePipelineStatusOutputError>())
