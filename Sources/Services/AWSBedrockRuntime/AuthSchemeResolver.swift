...
public struct BedrockRuntimeAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol BedrockRuntimeAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultBedrockRuntimeAuthSchemeResolver: BedrockRuntimeAuthSchemeResolver {
    public typealias Parameters = BedrockRuntimeAuthSchemeResolverParameters
