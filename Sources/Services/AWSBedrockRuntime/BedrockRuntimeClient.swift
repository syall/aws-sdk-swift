...
extension BedrockRuntimeClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any BedrockRuntimeAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any BedrockRuntimeAuthSchemeResolver)? = nil) throws {
...
extension BedrockRuntimeClient: BedrockRuntimeClientProtocol {
    ...
    public func invokeModel(input: InvokeModelInput) async throws -> InvokeModelOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<BedrockRuntimeAuthSchemeResolver, InvokeModelOutput, InvokeModelOutputError>())
    ...
    public func invokeModelWithResponseStream(input: InvokeModelWithResponseStreamInput) async throws -> InvokeModelWithResponseStreamOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<BedrockRuntimeAuthSchemeResolver, InvokeModelWithResponseStreamOutput, InvokeModelWithResponseStreamOutputError>())
