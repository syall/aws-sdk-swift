...
public class CloudWatchEventsClient {
    ...
    public init(config: CloudWatchEventsClient.CloudWatchEventsClientConfiguration) {
...
extension CloudWatchEventsClient {
    public typealias CloudWatchEventsClientConfiguration = AWSClientConfiguration<ServiceSpecificConfiguration>

    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        public typealias AWSServiceEndpointResolver = EndpointResolver
        public typealias AWSAuthSchemeResolver = CloudWatchEventsAuthSchemeResolver

        public var serviceName: String { "CloudWatch Events" }
        public var clientName: String { "CloudWatchEventsClient" }
        public var authSchemeResolver: any CloudWatchEventsAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any CloudWatchEventsAuthSchemeResolver)? = nil) throws {
...
extension CloudWatchEventsClient: CloudWatchEventsClientProtocol {
    ...
    public func activateEventSource(input: ActivateEventSourceInput) async throws -> ActivateEventSourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ActivateEventSourceOutput, ActivateEventSourceOutputError>())
    ...
    public func cancelReplay(input: CancelReplayInput) async throws -> CancelReplayOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, CancelReplayOutput, CancelReplayOutputError>())
    ...
    public func createApiDestination(input: CreateApiDestinationInput) async throws -> CreateApiDestinationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, CreateApiDestinationOutput, CreateApiDestinationOutputError>())
    ...
    public func createArchive(input: CreateArchiveInput) async throws -> CreateArchiveOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, CreateArchiveOutput, CreateArchiveOutputError>())
    ...
    public func createConnection(input: CreateConnectionInput) async throws -> CreateConnectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, CreateConnectionOutput, CreateConnectionOutputError>())
    ...
    public func createEventBus(input: CreateEventBusInput) async throws -> CreateEventBusOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, CreateEventBusOutput, CreateEventBusOutputError>())
    ...
    public func createPartnerEventSource(input: CreatePartnerEventSourceInput) async throws -> CreatePartnerEventSourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, CreatePartnerEventSourceOutput, CreatePartnerEventSourceOutputError>())
    ...
    public func deactivateEventSource(input: DeactivateEventSourceInput) async throws -> DeactivateEventSourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DeactivateEventSourceOutput, DeactivateEventSourceOutputError>())
    ...
    public func deauthorizeConnection(input: DeauthorizeConnectionInput) async throws -> DeauthorizeConnectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DeauthorizeConnectionOutput, DeauthorizeConnectionOutputError>())
    ...
    public func deleteApiDestination(input: DeleteApiDestinationInput) async throws -> DeleteApiDestinationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DeleteApiDestinationOutput, DeleteApiDestinationOutputError>())
    ...
    public func deleteArchive(input: DeleteArchiveInput) async throws -> DeleteArchiveOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DeleteArchiveOutput, DeleteArchiveOutputError>())
    ...
    public func deleteConnection(input: DeleteConnectionInput) async throws -> DeleteConnectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DeleteConnectionOutput, DeleteConnectionOutputError>())
    ...
    public func deleteEventBus(input: DeleteEventBusInput) async throws -> DeleteEventBusOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DeleteEventBusOutput, DeleteEventBusOutputError>())
    ...
    public func deletePartnerEventSource(input: DeletePartnerEventSourceInput) async throws -> DeletePartnerEventSourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DeletePartnerEventSourceOutput, DeletePartnerEventSourceOutputError>())
    ...
    public func deleteRule(input: DeleteRuleInput) async throws -> DeleteRuleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DeleteRuleOutput, DeleteRuleOutputError>())
    ...
    public func describeApiDestination(input: DescribeApiDestinationInput) async throws -> DescribeApiDestinationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DescribeApiDestinationOutput, DescribeApiDestinationOutputError>())
    ...
    public func describeArchive(input: DescribeArchiveInput) async throws -> DescribeArchiveOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DescribeArchiveOutput, DescribeArchiveOutputError>())
    ...
    public func describeConnection(input: DescribeConnectionInput) async throws -> DescribeConnectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DescribeConnectionOutput, DescribeConnectionOutputError>())
    ...
    public func describeEventBus(input: DescribeEventBusInput) async throws -> DescribeEventBusOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DescribeEventBusOutput, DescribeEventBusOutputError>())
    ...
    public func describeEventSource(input: DescribeEventSourceInput) async throws -> DescribeEventSourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DescribeEventSourceOutput, DescribeEventSourceOutputError>())
    ...
    public func describePartnerEventSource(input: DescribePartnerEventSourceInput) async throws -> DescribePartnerEventSourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DescribePartnerEventSourceOutput, DescribePartnerEventSourceOutputError>())
    ...
    public func describeReplay(input: DescribeReplayInput) async throws -> DescribeReplayOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DescribeReplayOutput, DescribeReplayOutputError>())
    ...
    public func describeRule(input: DescribeRuleInput) async throws -> DescribeRuleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DescribeRuleOutput, DescribeRuleOutputError>())
    ...
    public func disableRule(input: DisableRuleInput) async throws -> DisableRuleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, DisableRuleOutput, DisableRuleOutputError>())
    ...
    public func enableRule(input: EnableRuleInput) async throws -> EnableRuleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, EnableRuleOutput, EnableRuleOutputError>())
    ...
    public func listApiDestinations(input: ListApiDestinationsInput) async throws -> ListApiDestinationsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListApiDestinationsOutput, ListApiDestinationsOutputError>())
    ...
    public func listArchives(input: ListArchivesInput) async throws -> ListArchivesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListArchivesOutput, ListArchivesOutputError>())
    ...
    public func listConnections(input: ListConnectionsInput) async throws -> ListConnectionsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListConnectionsOutput, ListConnectionsOutputError>())
    ...
    public func listEventBuses(input: ListEventBusesInput) async throws -> ListEventBusesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListEventBusesOutput, ListEventBusesOutputError>())
    ...
    public func listEventSources(input: ListEventSourcesInput) async throws -> ListEventSourcesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListEventSourcesOutput, ListEventSourcesOutputError>())
    ...
    public func listPartnerEventSourceAccounts(input: ListPartnerEventSourceAccountsInput) async throws -> ListPartnerEventSourceAccountsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListPartnerEventSourceAccountsOutput, ListPartnerEventSourceAccountsOutputError>())
    ...
    public func listPartnerEventSources(input: ListPartnerEventSourcesInput) async throws -> ListPartnerEventSourcesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListPartnerEventSourcesOutput, ListPartnerEventSourcesOutputError>())
    ...
    public func listReplays(input: ListReplaysInput) async throws -> ListReplaysOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListReplaysOutput, ListReplaysOutputError>())
    ...
    public func listRuleNamesByTarget(input: ListRuleNamesByTargetInput) async throws -> ListRuleNamesByTargetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListRuleNamesByTargetOutput, ListRuleNamesByTargetOutputError>())
    ...
    public func listRules(input: ListRulesInput) async throws -> ListRulesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListRulesOutput, ListRulesOutputError>())
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListTagsForResourceOutput, ListTagsForResourceOutputError>())
    ...
    public func listTargetsByRule(input: ListTargetsByRuleInput) async throws -> ListTargetsByRuleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, ListTargetsByRuleOutput, ListTargetsByRuleOutputError>())
    ...
    public func putEvents(input: PutEventsInput) async throws -> PutEventsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, PutEventsOutput, PutEventsOutputError>())
    ...
    public func putPartnerEvents(input: PutPartnerEventsInput) async throws -> PutPartnerEventsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, PutPartnerEventsOutput, PutPartnerEventsOutputError>())
    ...
    public func putPermission(input: PutPermissionInput) async throws -> PutPermissionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, PutPermissionOutput, PutPermissionOutputError>())
    ...
    public func putRule(input: PutRuleInput) async throws -> PutRuleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, PutRuleOutput, PutRuleOutputError>())
    ...
    public func putTargets(input: PutTargetsInput) async throws -> PutTargetsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, PutTargetsOutput, PutTargetsOutputError>())
    ...
    public func removePermission(input: RemovePermissionInput) async throws -> RemovePermissionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, RemovePermissionOutput, RemovePermissionOutputError>())
    ...
    public func removeTargets(input: RemoveTargetsInput) async throws -> RemoveTargetsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, RemoveTargetsOutput, RemoveTargetsOutputError>())
    ...
    public func startReplay(input: StartReplayInput) async throws -> StartReplayOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, StartReplayOutput, StartReplayOutputError>())
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, TagResourceOutput, TagResourceOutputError>())
    ...
    public func testEventPattern(input: TestEventPatternInput) async throws -> TestEventPatternOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, TestEventPatternOutput, TestEventPatternOutputError>())
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, UntagResourceOutput, UntagResourceOutputError>())
    ...
    public func updateApiDestination(input: UpdateApiDestinationInput) async throws -> UpdateApiDestinationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, UpdateApiDestinationOutput, UpdateApiDestinationOutputError>())
    ...
    public func updateArchive(input: UpdateArchiveInput) async throws -> UpdateArchiveOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, UpdateArchiveOutput, UpdateArchiveOutputError>())
    ...
    public func updateConnection(input: UpdateConnectionInput) async throws -> UpdateConnectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudWatchEventsAuthSchemeResolver, UpdateConnectionOutput, UpdateConnectionOutputError>())
