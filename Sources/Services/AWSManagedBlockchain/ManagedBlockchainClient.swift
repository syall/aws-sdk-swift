...
extension ManagedBlockchainClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any ManagedBlockchainAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any ManagedBlockchainAuthSchemeResolver)? = nil) throws {
...
extension ManagedBlockchainClient: ManagedBlockchainClientProtocol {
    ...
    public func createAccessor(input: CreateAccessorInput) async throws -> CreateAccessorOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, CreateAccessorOutput, CreateAccessorOutputError>())
    ...
    public func createMember(input: CreateMemberInput) async throws -> CreateMemberOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, CreateMemberOutput, CreateMemberOutputError>())
    ...
    public func createNetwork(input: CreateNetworkInput) async throws -> CreateNetworkOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, CreateNetworkOutput, CreateNetworkOutputError>())
    ...
    public func createNode(input: CreateNodeInput) async throws -> CreateNodeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, CreateNodeOutput, CreateNodeOutputError>())
    ...
    public func createProposal(input: CreateProposalInput) async throws -> CreateProposalOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, CreateProposalOutput, CreateProposalOutputError>())
    ...
    public func deleteAccessor(input: DeleteAccessorInput) async throws -> DeleteAccessorOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, DeleteAccessorOutput, DeleteAccessorOutputError>())
    ...
    public func deleteMember(input: DeleteMemberInput) async throws -> DeleteMemberOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, DeleteMemberOutput, DeleteMemberOutputError>())
    ...
    public func deleteNode(input: DeleteNodeInput) async throws -> DeleteNodeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, DeleteNodeOutput, DeleteNodeOutputError>())
    ...
    public func getAccessor(input: GetAccessorInput) async throws -> GetAccessorOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, GetAccessorOutput, GetAccessorOutputError>())
    ...
    public func getMember(input: GetMemberInput) async throws -> GetMemberOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, GetMemberOutput, GetMemberOutputError>())
    ...
    public func getNetwork(input: GetNetworkInput) async throws -> GetNetworkOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, GetNetworkOutput, GetNetworkOutputError>())
    ...
    public func getNode(input: GetNodeInput) async throws -> GetNodeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, GetNodeOutput, GetNodeOutputError>())
    ...
    public func getProposal(input: GetProposalInput) async throws -> GetProposalOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, GetProposalOutput, GetProposalOutputError>())
    ...
    public func listAccessors(input: ListAccessorsInput) async throws -> ListAccessorsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, ListAccessorsOutput, ListAccessorsOutputError>())
    ...
    public func listInvitations(input: ListInvitationsInput) async throws -> ListInvitationsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, ListInvitationsOutput, ListInvitationsOutputError>())
    ...
    public func listMembers(input: ListMembersInput) async throws -> ListMembersOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, ListMembersOutput, ListMembersOutputError>())
    ...
    public func listNetworks(input: ListNetworksInput) async throws -> ListNetworksOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, ListNetworksOutput, ListNetworksOutputError>())
    ...
    public func listNodes(input: ListNodesInput) async throws -> ListNodesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, ListNodesOutput, ListNodesOutputError>())
    ...
    public func listProposalVotes(input: ListProposalVotesInput) async throws -> ListProposalVotesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, ListProposalVotesOutput, ListProposalVotesOutputError>())
    ...
    public func listProposals(input: ListProposalsInput) async throws -> ListProposalsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, ListProposalsOutput, ListProposalsOutputError>())
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, ListTagsForResourceOutput, ListTagsForResourceOutputError>())
    ...
    public func rejectInvitation(input: RejectInvitationInput) async throws -> RejectInvitationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, RejectInvitationOutput, RejectInvitationOutputError>())
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, TagResourceOutput, TagResourceOutputError>())
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, UntagResourceOutput, UntagResourceOutputError>())
    ...
    public func updateMember(input: UpdateMemberInput) async throws -> UpdateMemberOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, UpdateMemberOutput, UpdateMemberOutputError>())
    ...
    public func updateNode(input: UpdateNodeInput) async throws -> UpdateNodeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, UpdateNodeOutput, UpdateNodeOutputError>())
    ...
    public func voteOnProposal(input: VoteOnProposalInput) async throws -> VoteOnProposalOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ManagedBlockchainAuthSchemeResolver, VoteOnProposalOutput, VoteOnProposalOutputError>())
