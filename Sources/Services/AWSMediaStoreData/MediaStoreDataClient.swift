...
extension MediaStoreDataClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public typealias AWSAuthSchemeResolver = MediaStoreDataAuthSchemeResolver

        public var serviceName: String { "MediaStore Data" }
        public var clientName: String { "MediaStoreDataClient" }
        public var authSchemeResolver: any MediaStoreDataAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any MediaStoreDataAuthSchemeResolver)? = nil) throws {
...
extension MediaStoreDataClient: MediaStoreDataClientProtocol {
    ...
    public func deleteObject(input: DeleteObjectInput) async throws -> DeleteObjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MediaStoreDataAuthSchemeResolver, DeleteObjectOutput, DeleteObjectOutputError>())
    ...
    public func describeObject(input: DescribeObjectInput) async throws -> DescribeObjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MediaStoreDataAuthSchemeResolver, DescribeObjectOutput, DescribeObjectOutputError>())
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<DescribeObjectOutput, DescribeObjectOutputError>())
    ...
    public func getObject(input: GetObjectInput) async throws -> GetObjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MediaStoreDataAuthSchemeResolver, GetObjectOutput, GetObjectOutputError>())
    ...
    public func listItems(input: ListItemsInput) async throws -> ListItemsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MediaStoreDataAuthSchemeResolver, ListItemsOutput, ListItemsOutputError>())
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<ListItemsOutput, ListItemsOutputError>())
    ...
    public func putObject(input: PutObjectInput) async throws -> PutObjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MediaStoreDataAuthSchemeResolver, PutObjectOutput, PutObjectOutputError>())
