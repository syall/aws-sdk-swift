...
public struct OpsWorksCMAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol OpsWorksCMAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultOpsWorksCMAuthSchemeResolver: OpsWorksCMAuthSchemeResolver {
    public typealias Parameters = OpsWorksCMAuthSchemeResolverParameters
    ...
    public func resolveAuthScheme(params: Parameters) throws -> [AuthOption] {
        ...
        switch params.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: AttributeKeys.signingName, value: "opsworks-cm")
