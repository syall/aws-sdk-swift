...
extension OpsWorksCMClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any OpsWorksCMAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any OpsWorksCMAuthSchemeResolver)? = nil) throws {
...
extension OpsWorksCMClient: OpsWorksCMClientProtocol {
    ...
    public func associateNode(input: AssociateNodeInput) async throws -> AssociateNodeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, AssociateNodeOutput, AssociateNodeOutputError>())
    ...
    public func createBackup(input: CreateBackupInput) async throws -> CreateBackupOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, CreateBackupOutput, CreateBackupOutputError>())
    ...
    public func createServer(input: CreateServerInput) async throws -> CreateServerOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, CreateServerOutput, CreateServerOutputError>())
    ...
    public func deleteBackup(input: DeleteBackupInput) async throws -> DeleteBackupOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, DeleteBackupOutput, DeleteBackupOutputError>())
    ...
    public func deleteServer(input: DeleteServerInput) async throws -> DeleteServerOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, DeleteServerOutput, DeleteServerOutputError>())
    ...
    public func describeAccountAttributes(input: DescribeAccountAttributesInput) async throws -> DescribeAccountAttributesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, DescribeAccountAttributesOutput, DescribeAccountAttributesOutputError>())
    ...
    public func describeBackups(input: DescribeBackupsInput) async throws -> DescribeBackupsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, DescribeBackupsOutput, DescribeBackupsOutputError>())
    ...
    public func describeEvents(input: DescribeEventsInput) async throws -> DescribeEventsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, DescribeEventsOutput, DescribeEventsOutputError>())
    ...
    public func describeNodeAssociationStatus(input: DescribeNodeAssociationStatusInput) async throws -> DescribeNodeAssociationStatusOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, DescribeNodeAssociationStatusOutput, DescribeNodeAssociationStatusOutputError>())
    ...
    public func describeServers(input: DescribeServersInput) async throws -> DescribeServersOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, DescribeServersOutput, DescribeServersOutputError>())
    ...
    public func disassociateNode(input: DisassociateNodeInput) async throws -> DisassociateNodeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, DisassociateNodeOutput, DisassociateNodeOutputError>())
    ...
    public func exportServerEngineAttribute(input: ExportServerEngineAttributeInput) async throws -> ExportServerEngineAttributeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, ExportServerEngineAttributeOutput, ExportServerEngineAttributeOutputError>())
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, ListTagsForResourceOutput, ListTagsForResourceOutputError>())
    ...
    public func restoreServer(input: RestoreServerInput) async throws -> RestoreServerOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, RestoreServerOutput, RestoreServerOutputError>())
    ...
    public func startMaintenance(input: StartMaintenanceInput) async throws -> StartMaintenanceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, StartMaintenanceOutput, StartMaintenanceOutputError>())
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, TagResourceOutput, TagResourceOutputError>())
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, UntagResourceOutput, UntagResourceOutputError>())
    ...
    public func updateServer(input: UpdateServerInput) async throws -> UpdateServerOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, UpdateServerOutput, UpdateServerOutputError>())
    ...
    public func updateServerEngineAttributes(input: UpdateServerEngineAttributesInput) async throws -> UpdateServerEngineAttributesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<OpsWorksCMAuthSchemeResolver, UpdateServerEngineAttributesOutput, UpdateServerEngineAttributesOutputError>())
