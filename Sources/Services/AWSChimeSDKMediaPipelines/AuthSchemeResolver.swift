...
public struct ChimeSDKMediaPipelinesAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol ChimeSDKMediaPipelinesAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultChimeSDKMediaPipelinesAuthSchemeResolver: ChimeSDKMediaPipelinesAuthSchemeResolver {
    public typealias Parameters = ChimeSDKMediaPipelinesAuthSchemeResolverParameters
