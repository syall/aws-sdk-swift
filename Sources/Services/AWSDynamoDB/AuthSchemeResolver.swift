...
public struct DynamoDBAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol DynamoDBAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultDynamoDBAuthSchemeResolver: DynamoDBAuthSchemeResolver {
    public typealias Parameters = DynamoDBAuthSchemeResolverParameters
