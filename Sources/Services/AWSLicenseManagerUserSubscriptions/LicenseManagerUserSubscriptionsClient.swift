...
extension LicenseManagerUserSubscriptionsClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any LicenseManagerUserSubscriptionsAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any LicenseManagerUserSubscriptionsAuthSchemeResolver)? = nil) throws {
...
extension LicenseManagerUserSubscriptionsClient: LicenseManagerUserSubscriptionsClientProtocol {
    ...
    public func associateUser(input: AssociateUserInput) async throws -> AssociateUserOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LicenseManagerUserSubscriptionsAuthSchemeResolver, AssociateUserOutput, AssociateUserOutputError>())
    ...
    public func deregisterIdentityProvider(input: DeregisterIdentityProviderInput) async throws -> DeregisterIdentityProviderOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LicenseManagerUserSubscriptionsAuthSchemeResolver, DeregisterIdentityProviderOutput, DeregisterIdentityProviderOutputError>())
    ...
    public func disassociateUser(input: DisassociateUserInput) async throws -> DisassociateUserOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LicenseManagerUserSubscriptionsAuthSchemeResolver, DisassociateUserOutput, DisassociateUserOutputError>())
    ...
    public func listIdentityProviders(input: ListIdentityProvidersInput) async throws -> ListIdentityProvidersOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LicenseManagerUserSubscriptionsAuthSchemeResolver, ListIdentityProvidersOutput, ListIdentityProvidersOutputError>())
    ...
    public func listInstances(input: ListInstancesInput) async throws -> ListInstancesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LicenseManagerUserSubscriptionsAuthSchemeResolver, ListInstancesOutput, ListInstancesOutputError>())
    ...
    public func listProductSubscriptions(input: ListProductSubscriptionsInput) async throws -> ListProductSubscriptionsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LicenseManagerUserSubscriptionsAuthSchemeResolver, ListProductSubscriptionsOutput, ListProductSubscriptionsOutputError>())
    ...
    public func listUserAssociations(input: ListUserAssociationsInput) async throws -> ListUserAssociationsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LicenseManagerUserSubscriptionsAuthSchemeResolver, ListUserAssociationsOutput, ListUserAssociationsOutputError>())
    ...
    public func registerIdentityProvider(input: RegisterIdentityProviderInput) async throws -> RegisterIdentityProviderOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LicenseManagerUserSubscriptionsAuthSchemeResolver, RegisterIdentityProviderOutput, RegisterIdentityProviderOutputError>())
    ...
    public func startProductSubscription(input: StartProductSubscriptionInput) async throws -> StartProductSubscriptionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LicenseManagerUserSubscriptionsAuthSchemeResolver, StartProductSubscriptionOutput, StartProductSubscriptionOutputError>())
    ...
    public func stopProductSubscription(input: StopProductSubscriptionInput) async throws -> StopProductSubscriptionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LicenseManagerUserSubscriptionsAuthSchemeResolver, StopProductSubscriptionOutput, StopProductSubscriptionOutputError>())
    ...
    public func updateIdentityProviderSettings(input: UpdateIdentityProviderSettingsInput) async throws -> UpdateIdentityProviderSettingsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LicenseManagerUserSubscriptionsAuthSchemeResolver, UpdateIdentityProviderSettingsOutput, UpdateIdentityProviderSettingsOutputError>())
