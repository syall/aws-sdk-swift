...
public struct ConnectContactLensAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol ConnectContactLensAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultConnectContactLensAuthSchemeResolver: ConnectContactLensAuthSchemeResolver {
    public typealias Parameters = ConnectContactLensAuthSchemeResolverParameters
