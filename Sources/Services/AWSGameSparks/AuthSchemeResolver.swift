...
public struct GameSparksAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol GameSparksAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service GameSparks must conform to.
}

public struct DefaultGameSparksAuthSchemeResolver: GameSparksAuthSchemeResolver {
    public typealias Parameters = GameSparksAuthSchemeResolverParameters
    ...
    public func resolveAuthScheme(params: Parameters) throws -> [AuthOption] {
        ...
        switch params.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: AttributeKeys.signingName, value: "gamesparks")
    ...
    public func constructParameters(context: HttpContext) throws -> Parameters {
        ...
        return GameSparksAuthSchemeResolverParameters(operation: opName, region: opRegion)
    }
}
