...
extension AmplifyUIBuilderClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any AmplifyUIBuilderAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any AmplifyUIBuilderAuthSchemeResolver)? = nil) throws {
...
extension AmplifyUIBuilderClient: AmplifyUIBuilderClientProtocol {
    ...
    public func createComponent(input: CreateComponentInput) async throws -> CreateComponentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, CreateComponentOutput, CreateComponentOutputError>())
    ...
    public func createForm(input: CreateFormInput) async throws -> CreateFormOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, CreateFormOutput, CreateFormOutputError>())
    ...
    public func createTheme(input: CreateThemeInput) async throws -> CreateThemeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, CreateThemeOutput, CreateThemeOutputError>())
    ...
    public func deleteComponent(input: DeleteComponentInput) async throws -> DeleteComponentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, DeleteComponentOutput, DeleteComponentOutputError>())
    ...
    public func deleteForm(input: DeleteFormInput) async throws -> DeleteFormOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, DeleteFormOutput, DeleteFormOutputError>())
    ...
    public func deleteTheme(input: DeleteThemeInput) async throws -> DeleteThemeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, DeleteThemeOutput, DeleteThemeOutputError>())
    ...
    public func exchangeCodeForToken(input: ExchangeCodeForTokenInput) async throws -> ExchangeCodeForTokenOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, ExchangeCodeForTokenOutput, ExchangeCodeForTokenOutputError>())
    ...
    public func exportComponents(input: ExportComponentsInput) async throws -> ExportComponentsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, ExportComponentsOutput, ExportComponentsOutputError>())
    ...
    public func exportForms(input: ExportFormsInput) async throws -> ExportFormsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, ExportFormsOutput, ExportFormsOutputError>())
    ...
    public func exportThemes(input: ExportThemesInput) async throws -> ExportThemesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, ExportThemesOutput, ExportThemesOutputError>())
    ...
    public func getCodegenJob(input: GetCodegenJobInput) async throws -> GetCodegenJobOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, GetCodegenJobOutput, GetCodegenJobOutputError>())
    ...
    public func getComponent(input: GetComponentInput) async throws -> GetComponentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, GetComponentOutput, GetComponentOutputError>())
    ...
    public func getForm(input: GetFormInput) async throws -> GetFormOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, GetFormOutput, GetFormOutputError>())
    ...
    public func getMetadata(input: GetMetadataInput) async throws -> GetMetadataOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, GetMetadataOutput, GetMetadataOutputError>())
    ...
    public func getTheme(input: GetThemeInput) async throws -> GetThemeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, GetThemeOutput, GetThemeOutputError>())
    ...
    public func listCodegenJobs(input: ListCodegenJobsInput) async throws -> ListCodegenJobsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, ListCodegenJobsOutput, ListCodegenJobsOutputError>())
    ...
    public func listComponents(input: ListComponentsInput) async throws -> ListComponentsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, ListComponentsOutput, ListComponentsOutputError>())
    ...
    public func listForms(input: ListFormsInput) async throws -> ListFormsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, ListFormsOutput, ListFormsOutputError>())
    ...
    public func listThemes(input: ListThemesInput) async throws -> ListThemesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, ListThemesOutput, ListThemesOutputError>())
    ...
    public func putMetadataFlag(input: PutMetadataFlagInput) async throws -> PutMetadataFlagOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, PutMetadataFlagOutput, PutMetadataFlagOutputError>())
    ...
    public func refreshToken(input: RefreshTokenInput) async throws -> RefreshTokenOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, RefreshTokenOutput, RefreshTokenOutputError>())
    ...
    public func startCodegenJob(input: StartCodegenJobInput) async throws -> StartCodegenJobOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, StartCodegenJobOutput, StartCodegenJobOutputError>())
    ...
    public func updateComponent(input: UpdateComponentInput) async throws -> UpdateComponentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, UpdateComponentOutput, UpdateComponentOutputError>())
    ...
    public func updateForm(input: UpdateFormInput) async throws -> UpdateFormOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, UpdateFormOutput, UpdateFormOutputError>())
    ...
    public func updateTheme(input: UpdateThemeInput) async throws -> UpdateThemeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AmplifyUIBuilderAuthSchemeResolver, UpdateThemeOutput, UpdateThemeOutputError>())
