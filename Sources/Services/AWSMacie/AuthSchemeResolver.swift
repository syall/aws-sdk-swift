...
public struct MacieAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol MacieAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service Macie must conform to.
}

public struct DefaultMacieAuthSchemeResolver: MacieAuthSchemeResolver {
    public typealias Parameters = MacieAuthSchemeResolverParameters
    ...
    public func resolveAuthScheme(params: Parameters) throws -> [AuthOption] {
        ...
        switch params.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: AttributeKeys.signingName, value: "macie")
    ...
    public func constructParameters(context: HttpContext) throws -> Parameters {
        ...
        return MacieAuthSchemeResolverParameters(operation: opName, region: opRegion)
    }
}
