...
extension MacieClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public typealias AWSAuthSchemeResolver = MacieAuthSchemeResolver

        public var serviceName: String { "Macie" }
        public var clientName: String { "MacieClient" }
        public var authSchemeResolver: any MacieAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any MacieAuthSchemeResolver)? = nil) throws {
            self.endpointResolver = try endpointResolver ?? DefaultEndpointResolver()
            self.authSchemeResolver = authSchemeResolver ?? DefaultMacieAuthSchemeResolver()
        }
    }
}
...
extension MacieClient: MacieClientProtocol {
    ...
    public func associateMemberAccount(input: AssociateMemberAccountInput) async throws -> AssociateMemberAccountOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MacieAuthSchemeResolver, AssociateMemberAccountOutput, AssociateMemberAccountOutputError>())
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<AssociateMemberAccountOutput, AssociateMemberAccountOutputError>())
    ...
    public func associateS3Resources(input: AssociateS3ResourcesInput) async throws -> AssociateS3ResourcesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MacieAuthSchemeResolver, AssociateS3ResourcesOutput, AssociateS3ResourcesOutputError>())
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<AssociateS3ResourcesOutput, AssociateS3ResourcesOutputError>())
    ...
    public func disassociateMemberAccount(input: DisassociateMemberAccountInput) async throws -> DisassociateMemberAccountOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MacieAuthSchemeResolver, DisassociateMemberAccountOutput, DisassociateMemberAccountOutputError>())
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<DisassociateMemberAccountOutput, DisassociateMemberAccountOutputError>())
    ...
    public func disassociateS3Resources(input: DisassociateS3ResourcesInput) async throws -> DisassociateS3ResourcesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MacieAuthSchemeResolver, DisassociateS3ResourcesOutput, DisassociateS3ResourcesOutputError>())
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<DisassociateS3ResourcesOutput, DisassociateS3ResourcesOutputError>())
    ...
    public func listMemberAccounts(input: ListMemberAccountsInput) async throws -> ListMemberAccountsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MacieAuthSchemeResolver, ListMemberAccountsOutput, ListMemberAccountsOutputError>())
    ...
    public func listS3Resources(input: ListS3ResourcesInput) async throws -> ListS3ResourcesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MacieAuthSchemeResolver, ListS3ResourcesOutput, ListS3ResourcesOutputError>())
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<ListS3ResourcesOutput, ListS3ResourcesOutputError>())
    ...
    public func updateS3Resources(input: UpdateS3ResourcesInput) async throws -> UpdateS3ResourcesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MacieAuthSchemeResolver, UpdateS3ResourcesOutput, UpdateS3ResourcesOutputError>())
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<UpdateS3ResourcesOutput, UpdateS3ResourcesOutputError>())
