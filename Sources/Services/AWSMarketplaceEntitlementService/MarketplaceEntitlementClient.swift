...
extension MarketplaceEntitlementClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any MarketplaceEntitlementServiceAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any MarketplaceEntitlementServiceAuthSchemeResolver)? = nil) throws {
...
extension MarketplaceEntitlementClient: MarketplaceEntitlementClientProtocol {
    ...
    public func getEntitlements(input: GetEntitlementsInput) async throws -> GetEntitlementsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MarketplaceEntitlementServiceAuthSchemeResolver, GetEntitlementsOutput, GetEntitlementsOutputError>())
