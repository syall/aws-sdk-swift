...
extension STSClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any STSAuthSchemeResolver
        public var endpointResolver: EndpointResolver
        public var useGlobalEndpoint: Swift.Bool?

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any STSAuthSchemeResolver)? = nil) throws {
...
extension STSClient: STSClientProtocol {
    ...
    public func assumeRole(input: AssumeRoleInput) async throws -> AssumeRoleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<STSAuthSchemeResolver, AssumeRoleOutput, AssumeRoleOutputError>())
    ...
    public func assumeRoleWithSAML(input: AssumeRoleWithSAMLInput) async throws -> AssumeRoleWithSAMLOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<STSAuthSchemeResolver, AssumeRoleWithSAMLOutput, AssumeRoleWithSAMLOutputError>())
    ...
    public func assumeRoleWithWebIdentity(input: AssumeRoleWithWebIdentityInput) async throws -> AssumeRoleWithWebIdentityOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<STSAuthSchemeResolver, AssumeRoleWithWebIdentityOutput, AssumeRoleWithWebIdentityOutputError>())
    ...
    public func decodeAuthorizationMessage(input: DecodeAuthorizationMessageInput) async throws -> DecodeAuthorizationMessageOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<STSAuthSchemeResolver, DecodeAuthorizationMessageOutput, DecodeAuthorizationMessageOutputError>())
    ...
    public func getAccessKeyInfo(input: GetAccessKeyInfoInput) async throws -> GetAccessKeyInfoOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<STSAuthSchemeResolver, GetAccessKeyInfoOutput, GetAccessKeyInfoOutputError>())
    ...
    public func getCallerIdentity(input: GetCallerIdentityInput) async throws -> GetCallerIdentityOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<STSAuthSchemeResolver, GetCallerIdentityOutput, GetCallerIdentityOutputError>())
    ...
    public func getFederationToken(input: GetFederationTokenInput) async throws -> GetFederationTokenOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<STSAuthSchemeResolver, GetFederationTokenOutput, GetFederationTokenOutputError>())
    ...
    public func getSessionToken(input: GetSessionTokenInput) async throws -> GetSessionTokenOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<STSAuthSchemeResolver, GetSessionTokenOutput, GetSessionTokenOutputError>())
