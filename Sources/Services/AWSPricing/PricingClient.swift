...
extension PricingClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any PricingAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any PricingAuthSchemeResolver)? = nil) throws {
...
extension PricingClient: PricingClientProtocol {
    ...
    public func describeServices(input: DescribeServicesInput) async throws -> DescribeServicesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<PricingAuthSchemeResolver, DescribeServicesOutput, DescribeServicesOutputError>())
    ...
    public func getAttributeValues(input: GetAttributeValuesInput) async throws -> GetAttributeValuesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<PricingAuthSchemeResolver, GetAttributeValuesOutput, GetAttributeValuesOutputError>())
    ...
    public func getPriceListFileUrl(input: GetPriceListFileUrlInput) async throws -> GetPriceListFileUrlOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<PricingAuthSchemeResolver, GetPriceListFileUrlOutput, GetPriceListFileUrlOutputError>())
    ...
    public func getProducts(input: GetProductsInput) async throws -> GetProductsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<PricingAuthSchemeResolver, GetProductsOutput, GetProductsOutputError>())
    ...
    public func listPriceLists(input: ListPriceListsInput) async throws -> ListPriceListsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<PricingAuthSchemeResolver, ListPriceListsOutput, ListPriceListsOutputError>())
