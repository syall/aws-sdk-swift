...
public struct ChimeSDKIdentityAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol ChimeSDKIdentityAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultChimeSDKIdentityAuthSchemeResolver: ChimeSDKIdentityAuthSchemeResolver {
    public typealias Parameters = ChimeSDKIdentityAuthSchemeResolverParameters
