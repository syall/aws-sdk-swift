...
extension EvidentlyClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any EvidentlyAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any EvidentlyAuthSchemeResolver)? = nil) throws {
...
extension EvidentlyClient: EvidentlyClientProtocol {
    ...
    public func batchEvaluateFeature(input: BatchEvaluateFeatureInput) async throws -> BatchEvaluateFeatureOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, BatchEvaluateFeatureOutput, BatchEvaluateFeatureOutputError>())
    ...
    public func createExperiment(input: CreateExperimentInput) async throws -> CreateExperimentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, CreateExperimentOutput, CreateExperimentOutputError>())
    ...
    public func createFeature(input: CreateFeatureInput) async throws -> CreateFeatureOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, CreateFeatureOutput, CreateFeatureOutputError>())
    ...
    public func createLaunch(input: CreateLaunchInput) async throws -> CreateLaunchOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, CreateLaunchOutput, CreateLaunchOutputError>())
    ...
    public func createProject(input: CreateProjectInput) async throws -> CreateProjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, CreateProjectOutput, CreateProjectOutputError>())
    ...
    public func createSegment(input: CreateSegmentInput) async throws -> CreateSegmentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, CreateSegmentOutput, CreateSegmentOutputError>())
    ...
    public func deleteExperiment(input: DeleteExperimentInput) async throws -> DeleteExperimentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, DeleteExperimentOutput, DeleteExperimentOutputError>())
    ...
    public func deleteFeature(input: DeleteFeatureInput) async throws -> DeleteFeatureOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, DeleteFeatureOutput, DeleteFeatureOutputError>())
    ...
    public func deleteLaunch(input: DeleteLaunchInput) async throws -> DeleteLaunchOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, DeleteLaunchOutput, DeleteLaunchOutputError>())
    ...
    public func deleteProject(input: DeleteProjectInput) async throws -> DeleteProjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, DeleteProjectOutput, DeleteProjectOutputError>())
    ...
    public func deleteSegment(input: DeleteSegmentInput) async throws -> DeleteSegmentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, DeleteSegmentOutput, DeleteSegmentOutputError>())
    ...
    public func evaluateFeature(input: EvaluateFeatureInput) async throws -> EvaluateFeatureOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, EvaluateFeatureOutput, EvaluateFeatureOutputError>())
    ...
    public func getExperiment(input: GetExperimentInput) async throws -> GetExperimentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, GetExperimentOutput, GetExperimentOutputError>())
    ...
    public func getExperimentResults(input: GetExperimentResultsInput) async throws -> GetExperimentResultsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, GetExperimentResultsOutput, GetExperimentResultsOutputError>())
    ...
    public func getFeature(input: GetFeatureInput) async throws -> GetFeatureOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, GetFeatureOutput, GetFeatureOutputError>())
    ...
    public func getLaunch(input: GetLaunchInput) async throws -> GetLaunchOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, GetLaunchOutput, GetLaunchOutputError>())
    ...
    public func getProject(input: GetProjectInput) async throws -> GetProjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, GetProjectOutput, GetProjectOutputError>())
    ...
    public func getSegment(input: GetSegmentInput) async throws -> GetSegmentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, GetSegmentOutput, GetSegmentOutputError>())
    ...
    public func listExperiments(input: ListExperimentsInput) async throws -> ListExperimentsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, ListExperimentsOutput, ListExperimentsOutputError>())
    ...
    public func listFeatures(input: ListFeaturesInput) async throws -> ListFeaturesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, ListFeaturesOutput, ListFeaturesOutputError>())
    ...
    public func listLaunches(input: ListLaunchesInput) async throws -> ListLaunchesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, ListLaunchesOutput, ListLaunchesOutputError>())
    ...
    public func listProjects(input: ListProjectsInput) async throws -> ListProjectsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, ListProjectsOutput, ListProjectsOutputError>())
    ...
    public func listSegmentReferences(input: ListSegmentReferencesInput) async throws -> ListSegmentReferencesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, ListSegmentReferencesOutput, ListSegmentReferencesOutputError>())
    ...
    public func listSegments(input: ListSegmentsInput) async throws -> ListSegmentsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, ListSegmentsOutput, ListSegmentsOutputError>())
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, ListTagsForResourceOutput, ListTagsForResourceOutputError>())
    ...
    public func putProjectEvents(input: PutProjectEventsInput) async throws -> PutProjectEventsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, PutProjectEventsOutput, PutProjectEventsOutputError>())
    ...
    public func startExperiment(input: StartExperimentInput) async throws -> StartExperimentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, StartExperimentOutput, StartExperimentOutputError>())
    ...
    public func startLaunch(input: StartLaunchInput) async throws -> StartLaunchOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, StartLaunchOutput, StartLaunchOutputError>())
    ...
    public func stopExperiment(input: StopExperimentInput) async throws -> StopExperimentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, StopExperimentOutput, StopExperimentOutputError>())
    ...
    public func stopLaunch(input: StopLaunchInput) async throws -> StopLaunchOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, StopLaunchOutput, StopLaunchOutputError>())
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, TagResourceOutput, TagResourceOutputError>())
    ...
    public func testSegmentPattern(input: TestSegmentPatternInput) async throws -> TestSegmentPatternOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, TestSegmentPatternOutput, TestSegmentPatternOutputError>())
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, UntagResourceOutput, UntagResourceOutputError>())
    ...
    public func updateExperiment(input: UpdateExperimentInput) async throws -> UpdateExperimentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, UpdateExperimentOutput, UpdateExperimentOutputError>())
    ...
    public func updateFeature(input: UpdateFeatureInput) async throws -> UpdateFeatureOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, UpdateFeatureOutput, UpdateFeatureOutputError>())
    ...
    public func updateLaunch(input: UpdateLaunchInput) async throws -> UpdateLaunchOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, UpdateLaunchOutput, UpdateLaunchOutputError>())
    ...
    public func updateProject(input: UpdateProjectInput) async throws -> UpdateProjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, UpdateProjectOutput, UpdateProjectOutputError>())
    ...
    public func updateProjectDataDelivery(input: UpdateProjectDataDeliveryInput) async throws -> UpdateProjectDataDeliveryOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<EvidentlyAuthSchemeResolver, UpdateProjectDataDeliveryOutput, UpdateProjectDataDeliveryOutputError>())
