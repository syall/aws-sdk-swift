...
public struct KinesisVideoSignalingAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol KinesisVideoSignalingAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultKinesisVideoSignalingAuthSchemeResolver: KinesisVideoSignalingAuthSchemeResolver {
    public typealias Parameters = KinesisVideoSignalingAuthSchemeResolverParameters
