...
public struct ElasticsearchServiceAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol ElasticsearchServiceAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultElasticsearchServiceAuthSchemeResolver: ElasticsearchServiceAuthSchemeResolver {
    public typealias Parameters = ElasticsearchServiceAuthSchemeResolverParameters
