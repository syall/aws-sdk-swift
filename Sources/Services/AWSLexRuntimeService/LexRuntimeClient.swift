...
extension LexRuntimeClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any LexRuntimeServiceAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any LexRuntimeServiceAuthSchemeResolver)? = nil) throws {
...
extension LexRuntimeClient: LexRuntimeClientProtocol {
    ...
    public func deleteSession(input: DeleteSessionInput) async throws -> DeleteSessionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexRuntimeServiceAuthSchemeResolver, DeleteSessionOutput, DeleteSessionOutputError>())
    ...
    public func getSession(input: GetSessionInput) async throws -> GetSessionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexRuntimeServiceAuthSchemeResolver, GetSessionOutput, GetSessionOutputError>())
    ...
    public func postContent(input: PostContentInput) async throws -> PostContentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexRuntimeServiceAuthSchemeResolver, PostContentOutput, PostContentOutputError>())
    ...
    public func postText(input: PostTextInput) async throws -> PostTextOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexRuntimeServiceAuthSchemeResolver, PostTextOutput, PostTextOutputError>())
    ...
    public func putSession(input: PutSessionInput) async throws -> PutSessionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexRuntimeServiceAuthSchemeResolver, PutSessionOutput, PutSessionOutputError>())
