...
public struct GreengrassAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol GreengrassAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultGreengrassAuthSchemeResolver: GreengrassAuthSchemeResolver {
    public typealias Parameters = GreengrassAuthSchemeResolverParameters
