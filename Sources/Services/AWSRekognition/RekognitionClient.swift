...
extension RekognitionClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any RekognitionAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any RekognitionAuthSchemeResolver)? = nil) throws {
...
extension RekognitionClient: RekognitionClientProtocol {
    ...
    public func associateFaces(input: AssociateFacesInput) async throws -> AssociateFacesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, AssociateFacesOutput, AssociateFacesOutputError>())
    ...
    public func compareFaces(input: CompareFacesInput) async throws -> CompareFacesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, CompareFacesOutput, CompareFacesOutputError>())
    ...
    public func copyProjectVersion(input: CopyProjectVersionInput) async throws -> CopyProjectVersionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, CopyProjectVersionOutput, CopyProjectVersionOutputError>())
    ...
    public func createCollection(input: CreateCollectionInput) async throws -> CreateCollectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, CreateCollectionOutput, CreateCollectionOutputError>())
    ...
    public func createDataset(input: CreateDatasetInput) async throws -> CreateDatasetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, CreateDatasetOutput, CreateDatasetOutputError>())
    ...
    public func createFaceLivenessSession(input: CreateFaceLivenessSessionInput) async throws -> CreateFaceLivenessSessionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, CreateFaceLivenessSessionOutput, CreateFaceLivenessSessionOutputError>())
    ...
    public func createProject(input: CreateProjectInput) async throws -> CreateProjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, CreateProjectOutput, CreateProjectOutputError>())
    ...
    public func createProjectVersion(input: CreateProjectVersionInput) async throws -> CreateProjectVersionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, CreateProjectVersionOutput, CreateProjectVersionOutputError>())
    ...
    public func createStreamProcessor(input: CreateStreamProcessorInput) async throws -> CreateStreamProcessorOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, CreateStreamProcessorOutput, CreateStreamProcessorOutputError>())
    ...
    public func createUser(input: CreateUserInput) async throws -> CreateUserOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, CreateUserOutput, CreateUserOutputError>())
    ...
    public func deleteCollection(input: DeleteCollectionInput) async throws -> DeleteCollectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DeleteCollectionOutput, DeleteCollectionOutputError>())
    ...
    public func deleteDataset(input: DeleteDatasetInput) async throws -> DeleteDatasetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DeleteDatasetOutput, DeleteDatasetOutputError>())
    ...
    public func deleteFaces(input: DeleteFacesInput) async throws -> DeleteFacesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DeleteFacesOutput, DeleteFacesOutputError>())
    ...
    public func deleteProject(input: DeleteProjectInput) async throws -> DeleteProjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DeleteProjectOutput, DeleteProjectOutputError>())
    ...
    public func deleteProjectPolicy(input: DeleteProjectPolicyInput) async throws -> DeleteProjectPolicyOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DeleteProjectPolicyOutput, DeleteProjectPolicyOutputError>())
    ...
    public func deleteProjectVersion(input: DeleteProjectVersionInput) async throws -> DeleteProjectVersionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DeleteProjectVersionOutput, DeleteProjectVersionOutputError>())
    ...
    public func deleteStreamProcessor(input: DeleteStreamProcessorInput) async throws -> DeleteStreamProcessorOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DeleteStreamProcessorOutput, DeleteStreamProcessorOutputError>())
    ...
    public func deleteUser(input: DeleteUserInput) async throws -> DeleteUserOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DeleteUserOutput, DeleteUserOutputError>())
    ...
    public func describeCollection(input: DescribeCollectionInput) async throws -> DescribeCollectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DescribeCollectionOutput, DescribeCollectionOutputError>())
    ...
    public func describeDataset(input: DescribeDatasetInput) async throws -> DescribeDatasetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DescribeDatasetOutput, DescribeDatasetOutputError>())
    ...
    public func describeProjectVersions(input: DescribeProjectVersionsInput) async throws -> DescribeProjectVersionsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DescribeProjectVersionsOutput, DescribeProjectVersionsOutputError>())
    ...
    public func describeProjects(input: DescribeProjectsInput) async throws -> DescribeProjectsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DescribeProjectsOutput, DescribeProjectsOutputError>())
    ...
    public func describeStreamProcessor(input: DescribeStreamProcessorInput) async throws -> DescribeStreamProcessorOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DescribeStreamProcessorOutput, DescribeStreamProcessorOutputError>())
    ...
    public func detectCustomLabels(input: DetectCustomLabelsInput) async throws -> DetectCustomLabelsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DetectCustomLabelsOutput, DetectCustomLabelsOutputError>())
    ...
    public func detectFaces(input: DetectFacesInput) async throws -> DetectFacesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DetectFacesOutput, DetectFacesOutputError>())
    ...
    public func detectLabels(input: DetectLabelsInput) async throws -> DetectLabelsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DetectLabelsOutput, DetectLabelsOutputError>())
    ...
    public func detectModerationLabels(input: DetectModerationLabelsInput) async throws -> DetectModerationLabelsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DetectModerationLabelsOutput, DetectModerationLabelsOutputError>())
    ...
    public func detectProtectiveEquipment(input: DetectProtectiveEquipmentInput) async throws -> DetectProtectiveEquipmentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DetectProtectiveEquipmentOutput, DetectProtectiveEquipmentOutputError>())
    ...
    public func detectText(input: DetectTextInput) async throws -> DetectTextOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DetectTextOutput, DetectTextOutputError>())
    ...
    public func disassociateFaces(input: DisassociateFacesInput) async throws -> DisassociateFacesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DisassociateFacesOutput, DisassociateFacesOutputError>())
    ...
    public func distributeDatasetEntries(input: DistributeDatasetEntriesInput) async throws -> DistributeDatasetEntriesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, DistributeDatasetEntriesOutput, DistributeDatasetEntriesOutputError>())
    ...
    public func getCelebrityInfo(input: GetCelebrityInfoInput) async throws -> GetCelebrityInfoOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, GetCelebrityInfoOutput, GetCelebrityInfoOutputError>())
    ...
    public func getCelebrityRecognition(input: GetCelebrityRecognitionInput) async throws -> GetCelebrityRecognitionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, GetCelebrityRecognitionOutput, GetCelebrityRecognitionOutputError>())
    ...
    public func getContentModeration(input: GetContentModerationInput) async throws -> GetContentModerationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, GetContentModerationOutput, GetContentModerationOutputError>())
    ...
    public func getFaceDetection(input: GetFaceDetectionInput) async throws -> GetFaceDetectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, GetFaceDetectionOutput, GetFaceDetectionOutputError>())
    ...
    public func getFaceLivenessSessionResults(input: GetFaceLivenessSessionResultsInput) async throws -> GetFaceLivenessSessionResultsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, GetFaceLivenessSessionResultsOutput, GetFaceLivenessSessionResultsOutputError>())
    ...
    public func getFaceSearch(input: GetFaceSearchInput) async throws -> GetFaceSearchOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, GetFaceSearchOutput, GetFaceSearchOutputError>())
    ...
    public func getLabelDetection(input: GetLabelDetectionInput) async throws -> GetLabelDetectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, GetLabelDetectionOutput, GetLabelDetectionOutputError>())
    ...
    public func getPersonTracking(input: GetPersonTrackingInput) async throws -> GetPersonTrackingOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, GetPersonTrackingOutput, GetPersonTrackingOutputError>())
    ...
    public func getSegmentDetection(input: GetSegmentDetectionInput) async throws -> GetSegmentDetectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, GetSegmentDetectionOutput, GetSegmentDetectionOutputError>())
    ...
    public func getTextDetection(input: GetTextDetectionInput) async throws -> GetTextDetectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, GetTextDetectionOutput, GetTextDetectionOutputError>())
    ...
    public func indexFaces(input: IndexFacesInput) async throws -> IndexFacesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, IndexFacesOutput, IndexFacesOutputError>())
    ...
    public func listCollections(input: ListCollectionsInput) async throws -> ListCollectionsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, ListCollectionsOutput, ListCollectionsOutputError>())
    ...
    public func listDatasetEntries(input: ListDatasetEntriesInput) async throws -> ListDatasetEntriesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, ListDatasetEntriesOutput, ListDatasetEntriesOutputError>())
    ...
    public func listDatasetLabels(input: ListDatasetLabelsInput) async throws -> ListDatasetLabelsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, ListDatasetLabelsOutput, ListDatasetLabelsOutputError>())
    ...
    public func listFaces(input: ListFacesInput) async throws -> ListFacesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, ListFacesOutput, ListFacesOutputError>())
    ...
    public func listProjectPolicies(input: ListProjectPoliciesInput) async throws -> ListProjectPoliciesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, ListProjectPoliciesOutput, ListProjectPoliciesOutputError>())
    ...
    public func listStreamProcessors(input: ListStreamProcessorsInput) async throws -> ListStreamProcessorsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, ListStreamProcessorsOutput, ListStreamProcessorsOutputError>())
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, ListTagsForResourceOutput, ListTagsForResourceOutputError>())
    ...
    public func listUsers(input: ListUsersInput) async throws -> ListUsersOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, ListUsersOutput, ListUsersOutputError>())
    ...
    public func putProjectPolicy(input: PutProjectPolicyInput) async throws -> PutProjectPolicyOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, PutProjectPolicyOutput, PutProjectPolicyOutputError>())
    ...
    public func recognizeCelebrities(input: RecognizeCelebritiesInput) async throws -> RecognizeCelebritiesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, RecognizeCelebritiesOutput, RecognizeCelebritiesOutputError>())
    ...
    public func searchFaces(input: SearchFacesInput) async throws -> SearchFacesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, SearchFacesOutput, SearchFacesOutputError>())
    ...
    public func searchFacesByImage(input: SearchFacesByImageInput) async throws -> SearchFacesByImageOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, SearchFacesByImageOutput, SearchFacesByImageOutputError>())
    ...
    public func searchUsers(input: SearchUsersInput) async throws -> SearchUsersOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, SearchUsersOutput, SearchUsersOutputError>())
    ...
    public func searchUsersByImage(input: SearchUsersByImageInput) async throws -> SearchUsersByImageOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, SearchUsersByImageOutput, SearchUsersByImageOutputError>())
    ...
    public func startCelebrityRecognition(input: StartCelebrityRecognitionInput) async throws -> StartCelebrityRecognitionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StartCelebrityRecognitionOutput, StartCelebrityRecognitionOutputError>())
    ...
    public func startContentModeration(input: StartContentModerationInput) async throws -> StartContentModerationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StartContentModerationOutput, StartContentModerationOutputError>())
    ...
    public func startFaceDetection(input: StartFaceDetectionInput) async throws -> StartFaceDetectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StartFaceDetectionOutput, StartFaceDetectionOutputError>())
    ...
    public func startFaceSearch(input: StartFaceSearchInput) async throws -> StartFaceSearchOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StartFaceSearchOutput, StartFaceSearchOutputError>())
    ...
    public func startLabelDetection(input: StartLabelDetectionInput) async throws -> StartLabelDetectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StartLabelDetectionOutput, StartLabelDetectionOutputError>())
    ...
    public func startPersonTracking(input: StartPersonTrackingInput) async throws -> StartPersonTrackingOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StartPersonTrackingOutput, StartPersonTrackingOutputError>())
    ...
    public func startProjectVersion(input: StartProjectVersionInput) async throws -> StartProjectVersionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StartProjectVersionOutput, StartProjectVersionOutputError>())
    ...
    public func startSegmentDetection(input: StartSegmentDetectionInput) async throws -> StartSegmentDetectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StartSegmentDetectionOutput, StartSegmentDetectionOutputError>())
    ...
    public func startStreamProcessor(input: StartStreamProcessorInput) async throws -> StartStreamProcessorOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StartStreamProcessorOutput, StartStreamProcessorOutputError>())
    ...
    public func startTextDetection(input: StartTextDetectionInput) async throws -> StartTextDetectionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StartTextDetectionOutput, StartTextDetectionOutputError>())
    ...
    public func stopProjectVersion(input: StopProjectVersionInput) async throws -> StopProjectVersionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StopProjectVersionOutput, StopProjectVersionOutputError>())
    ...
    public func stopStreamProcessor(input: StopStreamProcessorInput) async throws -> StopStreamProcessorOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, StopStreamProcessorOutput, StopStreamProcessorOutputError>())
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, TagResourceOutput, TagResourceOutputError>())
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, UntagResourceOutput, UntagResourceOutputError>())
    ...
    public func updateDatasetEntries(input: UpdateDatasetEntriesInput) async throws -> UpdateDatasetEntriesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, UpdateDatasetEntriesOutput, UpdateDatasetEntriesOutputError>())
    ...
    public func updateStreamProcessor(input: UpdateStreamProcessorInput) async throws -> UpdateStreamProcessorOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RekognitionAuthSchemeResolver, UpdateStreamProcessorOutput, UpdateStreamProcessorOutputError>())
