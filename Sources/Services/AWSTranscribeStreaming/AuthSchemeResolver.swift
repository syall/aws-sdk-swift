...
public struct TranscribeStreamingAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol TranscribeStreamingAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultTranscribeStreamingAuthSchemeResolver: TranscribeStreamingAuthSchemeResolver {
    public typealias Parameters = TranscribeStreamingAuthSchemeResolverParameters
