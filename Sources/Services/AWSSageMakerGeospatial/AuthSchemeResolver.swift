...
public struct SageMakerGeospatialAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol SageMakerGeospatialAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultSageMakerGeospatialAuthSchemeResolver: SageMakerGeospatialAuthSchemeResolver {
    public typealias Parameters = SageMakerGeospatialAuthSchemeResolverParameters
    ...
    public func resolveAuthScheme(params: Parameters) throws -> [AuthOption] {
        ...
        switch params.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: AttributeKeys.signingName, value: "sagemaker-geospatial")
