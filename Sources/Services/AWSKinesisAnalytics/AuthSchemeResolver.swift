...
public struct KinesisAnalyticsAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol KinesisAnalyticsAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultKinesisAnalyticsAuthSchemeResolver: KinesisAnalyticsAuthSchemeResolver {
    public typealias Parameters = KinesisAnalyticsAuthSchemeResolverParameters
