...
public struct SageMakerMetricsAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol SageMakerMetricsAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultSageMakerMetricsAuthSchemeResolver: SageMakerMetricsAuthSchemeResolver {
    public typealias Parameters = SageMakerMetricsAuthSchemeResolverParameters
