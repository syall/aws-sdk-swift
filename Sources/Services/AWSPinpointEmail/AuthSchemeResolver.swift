...
public struct PinpointEmailAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol PinpointEmailAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultPinpointEmailAuthSchemeResolver: PinpointEmailAuthSchemeResolver {
    public typealias Parameters = PinpointEmailAuthSchemeResolverParameters
