...
extension ForecastqueryClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any ForecastqueryAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any ForecastqueryAuthSchemeResolver)? = nil) throws {
...
extension ForecastqueryClient: ForecastqueryClientProtocol {
    ...
    public func queryForecast(input: QueryForecastInput) async throws -> QueryForecastOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ForecastqueryAuthSchemeResolver, QueryForecastOutput, QueryForecastOutputError>())
    ...
    public func queryWhatIfForecast(input: QueryWhatIfForecastInput) async throws -> QueryWhatIfForecastOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ForecastqueryAuthSchemeResolver, QueryWhatIfForecastOutput, QueryWhatIfForecastOutputError>())
