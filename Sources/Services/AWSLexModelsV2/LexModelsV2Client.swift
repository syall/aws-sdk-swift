...
extension LexModelsV2Client {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any LexModelsV2AuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any LexModelsV2AuthSchemeResolver)? = nil) throws {
...
extension LexModelsV2Client: LexModelsV2ClientProtocol {
    ...
    public func batchCreateCustomVocabularyItem(input: BatchCreateCustomVocabularyItemInput) async throws -> BatchCreateCustomVocabularyItemOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, BatchCreateCustomVocabularyItemOutput, BatchCreateCustomVocabularyItemOutputError>())
    ...
    public func batchDeleteCustomVocabularyItem(input: BatchDeleteCustomVocabularyItemInput) async throws -> BatchDeleteCustomVocabularyItemOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, BatchDeleteCustomVocabularyItemOutput, BatchDeleteCustomVocabularyItemOutputError>())
    ...
    public func batchUpdateCustomVocabularyItem(input: BatchUpdateCustomVocabularyItemInput) async throws -> BatchUpdateCustomVocabularyItemOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, BatchUpdateCustomVocabularyItemOutput, BatchUpdateCustomVocabularyItemOutputError>())
    ...
    public func buildBotLocale(input: BuildBotLocaleInput) async throws -> BuildBotLocaleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, BuildBotLocaleOutput, BuildBotLocaleOutputError>())
    ...
    public func createBot(input: CreateBotInput) async throws -> CreateBotOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateBotOutput, CreateBotOutputError>())
    ...
    public func createBotAlias(input: CreateBotAliasInput) async throws -> CreateBotAliasOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateBotAliasOutput, CreateBotAliasOutputError>())
    ...
    public func createBotLocale(input: CreateBotLocaleInput) async throws -> CreateBotLocaleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateBotLocaleOutput, CreateBotLocaleOutputError>())
    ...
    public func createBotVersion(input: CreateBotVersionInput) async throws -> CreateBotVersionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateBotVersionOutput, CreateBotVersionOutputError>())
    ...
    public func createExport(input: CreateExportInput) async throws -> CreateExportOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateExportOutput, CreateExportOutputError>())
    ...
    public func createIntent(input: CreateIntentInput) async throws -> CreateIntentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateIntentOutput, CreateIntentOutputError>())
    ...
    public func createResourcePolicy(input: CreateResourcePolicyInput) async throws -> CreateResourcePolicyOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateResourcePolicyOutput, CreateResourcePolicyOutputError>())
    ...
    public func createResourcePolicyStatement(input: CreateResourcePolicyStatementInput) async throws -> CreateResourcePolicyStatementOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateResourcePolicyStatementOutput, CreateResourcePolicyStatementOutputError>())
    ...
    public func createSlot(input: CreateSlotInput) async throws -> CreateSlotOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateSlotOutput, CreateSlotOutputError>())
    ...
    public func createSlotType(input: CreateSlotTypeInput) async throws -> CreateSlotTypeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateSlotTypeOutput, CreateSlotTypeOutputError>())
    ...
    public func createTestSetDiscrepancyReport(input: CreateTestSetDiscrepancyReportInput) async throws -> CreateTestSetDiscrepancyReportOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateTestSetDiscrepancyReportOutput, CreateTestSetDiscrepancyReportOutputError>())
    ...
    public func createUploadUrl(input: CreateUploadUrlInput) async throws -> CreateUploadUrlOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, CreateUploadUrlOutput, CreateUploadUrlOutputError>())
    ...
    public func deleteBot(input: DeleteBotInput) async throws -> DeleteBotOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteBotOutput, DeleteBotOutputError>())
    ...
    public func deleteBotAlias(input: DeleteBotAliasInput) async throws -> DeleteBotAliasOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteBotAliasOutput, DeleteBotAliasOutputError>())
    ...
    public func deleteBotLocale(input: DeleteBotLocaleInput) async throws -> DeleteBotLocaleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteBotLocaleOutput, DeleteBotLocaleOutputError>())
    ...
    public func deleteBotVersion(input: DeleteBotVersionInput) async throws -> DeleteBotVersionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteBotVersionOutput, DeleteBotVersionOutputError>())
    ...
    public func deleteCustomVocabulary(input: DeleteCustomVocabularyInput) async throws -> DeleteCustomVocabularyOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteCustomVocabularyOutput, DeleteCustomVocabularyOutputError>())
    ...
    public func deleteExport(input: DeleteExportInput) async throws -> DeleteExportOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteExportOutput, DeleteExportOutputError>())
    ...
    public func deleteImport(input: DeleteImportInput) async throws -> DeleteImportOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteImportOutput, DeleteImportOutputError>())
    ...
    public func deleteIntent(input: DeleteIntentInput) async throws -> DeleteIntentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteIntentOutput, DeleteIntentOutputError>())
    ...
    public func deleteResourcePolicy(input: DeleteResourcePolicyInput) async throws -> DeleteResourcePolicyOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteResourcePolicyOutput, DeleteResourcePolicyOutputError>())
    ...
    public func deleteResourcePolicyStatement(input: DeleteResourcePolicyStatementInput) async throws -> DeleteResourcePolicyStatementOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteResourcePolicyStatementOutput, DeleteResourcePolicyStatementOutputError>())
    ...
    public func deleteSlot(input: DeleteSlotInput) async throws -> DeleteSlotOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteSlotOutput, DeleteSlotOutputError>())
    ...
    public func deleteSlotType(input: DeleteSlotTypeInput) async throws -> DeleteSlotTypeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteSlotTypeOutput, DeleteSlotTypeOutputError>())
    ...
    public func deleteTestSet(input: DeleteTestSetInput) async throws -> DeleteTestSetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteTestSetOutput, DeleteTestSetOutputError>())
    ...
    public func deleteUtterances(input: DeleteUtterancesInput) async throws -> DeleteUtterancesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DeleteUtterancesOutput, DeleteUtterancesOutputError>())
    ...
    public func describeBot(input: DescribeBotInput) async throws -> DescribeBotOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeBotOutput, DescribeBotOutputError>())
    ...
    public func describeBotAlias(input: DescribeBotAliasInput) async throws -> DescribeBotAliasOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeBotAliasOutput, DescribeBotAliasOutputError>())
    ...
    public func describeBotLocale(input: DescribeBotLocaleInput) async throws -> DescribeBotLocaleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeBotLocaleOutput, DescribeBotLocaleOutputError>())
    ...
    public func describeBotRecommendation(input: DescribeBotRecommendationInput) async throws -> DescribeBotRecommendationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeBotRecommendationOutput, DescribeBotRecommendationOutputError>())
    ...
    public func describeBotVersion(input: DescribeBotVersionInput) async throws -> DescribeBotVersionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeBotVersionOutput, DescribeBotVersionOutputError>())
    ...
    public func describeCustomVocabularyMetadata(input: DescribeCustomVocabularyMetadataInput) async throws -> DescribeCustomVocabularyMetadataOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeCustomVocabularyMetadataOutput, DescribeCustomVocabularyMetadataOutputError>())
    ...
    public func describeExport(input: DescribeExportInput) async throws -> DescribeExportOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeExportOutput, DescribeExportOutputError>())
    ...
    public func describeImport(input: DescribeImportInput) async throws -> DescribeImportOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeImportOutput, DescribeImportOutputError>())
    ...
    public func describeIntent(input: DescribeIntentInput) async throws -> DescribeIntentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeIntentOutput, DescribeIntentOutputError>())
    ...
    public func describeResourcePolicy(input: DescribeResourcePolicyInput) async throws -> DescribeResourcePolicyOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeResourcePolicyOutput, DescribeResourcePolicyOutputError>())
    ...
    public func describeSlot(input: DescribeSlotInput) async throws -> DescribeSlotOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeSlotOutput, DescribeSlotOutputError>())
    ...
    public func describeSlotType(input: DescribeSlotTypeInput) async throws -> DescribeSlotTypeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeSlotTypeOutput, DescribeSlotTypeOutputError>())
    ...
    public func describeTestExecution(input: DescribeTestExecutionInput) async throws -> DescribeTestExecutionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeTestExecutionOutput, DescribeTestExecutionOutputError>())
    ...
    public func describeTestSet(input: DescribeTestSetInput) async throws -> DescribeTestSetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeTestSetOutput, DescribeTestSetOutputError>())
    ...
    public func describeTestSetDiscrepancyReport(input: DescribeTestSetDiscrepancyReportInput) async throws -> DescribeTestSetDiscrepancyReportOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeTestSetDiscrepancyReportOutput, DescribeTestSetDiscrepancyReportOutputError>())
    ...
    public func describeTestSetGeneration(input: DescribeTestSetGenerationInput) async throws -> DescribeTestSetGenerationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, DescribeTestSetGenerationOutput, DescribeTestSetGenerationOutputError>())
    ...
    public func getTestExecutionArtifactsUrl(input: GetTestExecutionArtifactsUrlInput) async throws -> GetTestExecutionArtifactsUrlOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, GetTestExecutionArtifactsUrlOutput, GetTestExecutionArtifactsUrlOutputError>())
    ...
    public func listAggregatedUtterances(input: ListAggregatedUtterancesInput) async throws -> ListAggregatedUtterancesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListAggregatedUtterancesOutput, ListAggregatedUtterancesOutputError>())
    ...
    public func listBotAliases(input: ListBotAliasesInput) async throws -> ListBotAliasesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListBotAliasesOutput, ListBotAliasesOutputError>())
    ...
    public func listBotLocales(input: ListBotLocalesInput) async throws -> ListBotLocalesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListBotLocalesOutput, ListBotLocalesOutputError>())
    ...
    public func listBotRecommendations(input: ListBotRecommendationsInput) async throws -> ListBotRecommendationsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListBotRecommendationsOutput, ListBotRecommendationsOutputError>())
    ...
    public func listBotVersions(input: ListBotVersionsInput) async throws -> ListBotVersionsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListBotVersionsOutput, ListBotVersionsOutputError>())
    ...
    public func listBots(input: ListBotsInput) async throws -> ListBotsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListBotsOutput, ListBotsOutputError>())
    ...
    public func listBuiltInIntents(input: ListBuiltInIntentsInput) async throws -> ListBuiltInIntentsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListBuiltInIntentsOutput, ListBuiltInIntentsOutputError>())
    ...
    public func listBuiltInSlotTypes(input: ListBuiltInSlotTypesInput) async throws -> ListBuiltInSlotTypesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListBuiltInSlotTypesOutput, ListBuiltInSlotTypesOutputError>())
    ...
    public func listCustomVocabularyItems(input: ListCustomVocabularyItemsInput) async throws -> ListCustomVocabularyItemsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListCustomVocabularyItemsOutput, ListCustomVocabularyItemsOutputError>())
    ...
    public func listExports(input: ListExportsInput) async throws -> ListExportsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListExportsOutput, ListExportsOutputError>())
    ...
    public func listImports(input: ListImportsInput) async throws -> ListImportsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListImportsOutput, ListImportsOutputError>())
    ...
    public func listIntentMetrics(input: ListIntentMetricsInput) async throws -> ListIntentMetricsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListIntentMetricsOutput, ListIntentMetricsOutputError>())
    ...
    public func listIntentPaths(input: ListIntentPathsInput) async throws -> ListIntentPathsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListIntentPathsOutput, ListIntentPathsOutputError>())
    ...
    public func listIntentStageMetrics(input: ListIntentStageMetricsInput) async throws -> ListIntentStageMetricsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListIntentStageMetricsOutput, ListIntentStageMetricsOutputError>())
    ...
    public func listIntents(input: ListIntentsInput) async throws -> ListIntentsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListIntentsOutput, ListIntentsOutputError>())
    ...
    public func listRecommendedIntents(input: ListRecommendedIntentsInput) async throws -> ListRecommendedIntentsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListRecommendedIntentsOutput, ListRecommendedIntentsOutputError>())
    ...
    public func listSessionAnalyticsData(input: ListSessionAnalyticsDataInput) async throws -> ListSessionAnalyticsDataOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListSessionAnalyticsDataOutput, ListSessionAnalyticsDataOutputError>())
    ...
    public func listSessionMetrics(input: ListSessionMetricsInput) async throws -> ListSessionMetricsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListSessionMetricsOutput, ListSessionMetricsOutputError>())
    ...
    public func listSlotTypes(input: ListSlotTypesInput) async throws -> ListSlotTypesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListSlotTypesOutput, ListSlotTypesOutputError>())
    ...
    public func listSlots(input: ListSlotsInput) async throws -> ListSlotsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListSlotsOutput, ListSlotsOutputError>())
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListTagsForResourceOutput, ListTagsForResourceOutputError>())
    ...
    public func listTestExecutionResultItems(input: ListTestExecutionResultItemsInput) async throws -> ListTestExecutionResultItemsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListTestExecutionResultItemsOutput, ListTestExecutionResultItemsOutputError>())
    ...
    public func listTestExecutions(input: ListTestExecutionsInput) async throws -> ListTestExecutionsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListTestExecutionsOutput, ListTestExecutionsOutputError>())
    ...
    public func listTestSetRecords(input: ListTestSetRecordsInput) async throws -> ListTestSetRecordsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListTestSetRecordsOutput, ListTestSetRecordsOutputError>())
    ...
    public func listTestSets(input: ListTestSetsInput) async throws -> ListTestSetsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListTestSetsOutput, ListTestSetsOutputError>())
    ...
    public func listUtteranceAnalyticsData(input: ListUtteranceAnalyticsDataInput) async throws -> ListUtteranceAnalyticsDataOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListUtteranceAnalyticsDataOutput, ListUtteranceAnalyticsDataOutputError>())
    ...
    public func listUtteranceMetrics(input: ListUtteranceMetricsInput) async throws -> ListUtteranceMetricsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, ListUtteranceMetricsOutput, ListUtteranceMetricsOutputError>())
    ...
    public func searchAssociatedTranscripts(input: SearchAssociatedTranscriptsInput) async throws -> SearchAssociatedTranscriptsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, SearchAssociatedTranscriptsOutput, SearchAssociatedTranscriptsOutputError>())
    ...
    public func startBotRecommendation(input: StartBotRecommendationInput) async throws -> StartBotRecommendationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, StartBotRecommendationOutput, StartBotRecommendationOutputError>())
    ...
    public func startImport(input: StartImportInput) async throws -> StartImportOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, StartImportOutput, StartImportOutputError>())
    ...
    public func startTestExecution(input: StartTestExecutionInput) async throws -> StartTestExecutionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, StartTestExecutionOutput, StartTestExecutionOutputError>())
    ...
    public func startTestSetGeneration(input: StartTestSetGenerationInput) async throws -> StartTestSetGenerationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, StartTestSetGenerationOutput, StartTestSetGenerationOutputError>())
    ...
    public func stopBotRecommendation(input: StopBotRecommendationInput) async throws -> StopBotRecommendationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, StopBotRecommendationOutput, StopBotRecommendationOutputError>())
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, TagResourceOutput, TagResourceOutputError>())
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, UntagResourceOutput, UntagResourceOutputError>())
    ...
    public func updateBot(input: UpdateBotInput) async throws -> UpdateBotOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, UpdateBotOutput, UpdateBotOutputError>())
    ...
    public func updateBotAlias(input: UpdateBotAliasInput) async throws -> UpdateBotAliasOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, UpdateBotAliasOutput, UpdateBotAliasOutputError>())
    ...
    public func updateBotLocale(input: UpdateBotLocaleInput) async throws -> UpdateBotLocaleOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, UpdateBotLocaleOutput, UpdateBotLocaleOutputError>())
    ...
    public func updateBotRecommendation(input: UpdateBotRecommendationInput) async throws -> UpdateBotRecommendationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, UpdateBotRecommendationOutput, UpdateBotRecommendationOutputError>())
    ...
    public func updateExport(input: UpdateExportInput) async throws -> UpdateExportOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, UpdateExportOutput, UpdateExportOutputError>())
    ...
    public func updateIntent(input: UpdateIntentInput) async throws -> UpdateIntentOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, UpdateIntentOutput, UpdateIntentOutputError>())
    ...
    public func updateResourcePolicy(input: UpdateResourcePolicyInput) async throws -> UpdateResourcePolicyOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, UpdateResourcePolicyOutput, UpdateResourcePolicyOutputError>())
    ...
    public func updateSlot(input: UpdateSlotInput) async throws -> UpdateSlotOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, UpdateSlotOutput, UpdateSlotOutputError>())
    ...
    public func updateSlotType(input: UpdateSlotTypeInput) async throws -> UpdateSlotTypeOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, UpdateSlotTypeOutput, UpdateSlotTypeOutputError>())
    ...
    public func updateTestSet(input: UpdateTestSetInput) async throws -> UpdateTestSetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<LexModelsV2AuthSchemeResolver, UpdateTestSetOutput, UpdateTestSetOutputError>())
