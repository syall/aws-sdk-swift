...
public struct ServiceCatalogAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol ServiceCatalogAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultServiceCatalogAuthSchemeResolver: ServiceCatalogAuthSchemeResolver {
    public typealias Parameters = ServiceCatalogAuthSchemeResolverParameters
