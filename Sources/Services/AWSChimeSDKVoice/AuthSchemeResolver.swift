...
public struct ChimeSDKVoiceAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol ChimeSDKVoiceAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultChimeSDKVoiceAuthSchemeResolver: ChimeSDKVoiceAuthSchemeResolver {
    public typealias Parameters = ChimeSDKVoiceAuthSchemeResolverParameters
