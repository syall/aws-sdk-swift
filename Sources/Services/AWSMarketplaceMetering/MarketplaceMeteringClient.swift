...
extension MarketplaceMeteringClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any MarketplaceMeteringAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any MarketplaceMeteringAuthSchemeResolver)? = nil) throws {
...
extension MarketplaceMeteringClient: MarketplaceMeteringClientProtocol {
    ...
    public func batchMeterUsage(input: BatchMeterUsageInput) async throws -> BatchMeterUsageOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MarketplaceMeteringAuthSchemeResolver, BatchMeterUsageOutput, BatchMeterUsageOutputError>())
    ...
    public func meterUsage(input: MeterUsageInput) async throws -> MeterUsageOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MarketplaceMeteringAuthSchemeResolver, MeterUsageOutput, MeterUsageOutputError>())
    ...
    public func registerUsage(input: RegisterUsageInput) async throws -> RegisterUsageOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MarketplaceMeteringAuthSchemeResolver, RegisterUsageOutput, RegisterUsageOutputError>())
    ...
    public func resolveCustomer(input: ResolveCustomerInput) async throws -> ResolveCustomerOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<MarketplaceMeteringAuthSchemeResolver, ResolveCustomerOutput, ResolveCustomerOutputError>())
