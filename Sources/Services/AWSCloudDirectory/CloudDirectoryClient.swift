...
extension CloudDirectoryClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public var authSchemeResolver: any CloudDirectoryAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: (any CloudDirectoryAuthSchemeResolver)? = nil) throws {
...
extension CloudDirectoryClient: CloudDirectoryClientProtocol {
    ...
    public func addFacetToObject(input: AddFacetToObjectInput) async throws -> AddFacetToObjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, AddFacetToObjectOutput, AddFacetToObjectOutputError>())
    ...
    public func applySchema(input: ApplySchemaInput) async throws -> ApplySchemaOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ApplySchemaOutput, ApplySchemaOutputError>())
    ...
    public func attachObject(input: AttachObjectInput) async throws -> AttachObjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, AttachObjectOutput, AttachObjectOutputError>())
    ...
    public func attachPolicy(input: AttachPolicyInput) async throws -> AttachPolicyOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, AttachPolicyOutput, AttachPolicyOutputError>())
    ...
    public func attachToIndex(input: AttachToIndexInput) async throws -> AttachToIndexOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, AttachToIndexOutput, AttachToIndexOutputError>())
    ...
    public func attachTypedLink(input: AttachTypedLinkInput) async throws -> AttachTypedLinkOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, AttachTypedLinkOutput, AttachTypedLinkOutputError>())
    ...
    public func batchRead(input: BatchReadInput) async throws -> BatchReadOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, BatchReadOutput, BatchReadOutputError>())
    ...
    public func batchWrite(input: BatchWriteInput) async throws -> BatchWriteOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, BatchWriteOutput, BatchWriteOutputError>())
    ...
    public func createDirectory(input: CreateDirectoryInput) async throws -> CreateDirectoryOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, CreateDirectoryOutput, CreateDirectoryOutputError>())
    ...
    public func createFacet(input: CreateFacetInput) async throws -> CreateFacetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, CreateFacetOutput, CreateFacetOutputError>())
    ...
    public func createIndex(input: CreateIndexInput) async throws -> CreateIndexOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, CreateIndexOutput, CreateIndexOutputError>())
    ...
    public func createObject(input: CreateObjectInput) async throws -> CreateObjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, CreateObjectOutput, CreateObjectOutputError>())
    ...
    public func createSchema(input: CreateSchemaInput) async throws -> CreateSchemaOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, CreateSchemaOutput, CreateSchemaOutputError>())
    ...
    public func createTypedLinkFacet(input: CreateTypedLinkFacetInput) async throws -> CreateTypedLinkFacetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, CreateTypedLinkFacetOutput, CreateTypedLinkFacetOutputError>())
    ...
    public func deleteDirectory(input: DeleteDirectoryInput) async throws -> DeleteDirectoryOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, DeleteDirectoryOutput, DeleteDirectoryOutputError>())
    ...
    public func deleteFacet(input: DeleteFacetInput) async throws -> DeleteFacetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, DeleteFacetOutput, DeleteFacetOutputError>())
    ...
    public func deleteObject(input: DeleteObjectInput) async throws -> DeleteObjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, DeleteObjectOutput, DeleteObjectOutputError>())
    ...
    public func deleteSchema(input: DeleteSchemaInput) async throws -> DeleteSchemaOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, DeleteSchemaOutput, DeleteSchemaOutputError>())
    ...
    public func deleteTypedLinkFacet(input: DeleteTypedLinkFacetInput) async throws -> DeleteTypedLinkFacetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, DeleteTypedLinkFacetOutput, DeleteTypedLinkFacetOutputError>())
    ...
    public func detachFromIndex(input: DetachFromIndexInput) async throws -> DetachFromIndexOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, DetachFromIndexOutput, DetachFromIndexOutputError>())
    ...
    public func detachObject(input: DetachObjectInput) async throws -> DetachObjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, DetachObjectOutput, DetachObjectOutputError>())
    ...
    public func detachPolicy(input: DetachPolicyInput) async throws -> DetachPolicyOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, DetachPolicyOutput, DetachPolicyOutputError>())
    ...
    public func detachTypedLink(input: DetachTypedLinkInput) async throws -> DetachTypedLinkOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, DetachTypedLinkOutput, DetachTypedLinkOutputError>())
    ...
    public func disableDirectory(input: DisableDirectoryInput) async throws -> DisableDirectoryOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, DisableDirectoryOutput, DisableDirectoryOutputError>())
    ...
    public func enableDirectory(input: EnableDirectoryInput) async throws -> EnableDirectoryOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, EnableDirectoryOutput, EnableDirectoryOutputError>())
    ...
    public func getAppliedSchemaVersion(input: GetAppliedSchemaVersionInput) async throws -> GetAppliedSchemaVersionOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, GetAppliedSchemaVersionOutput, GetAppliedSchemaVersionOutputError>())
    ...
    public func getDirectory(input: GetDirectoryInput) async throws -> GetDirectoryOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, GetDirectoryOutput, GetDirectoryOutputError>())
    ...
    public func getFacet(input: GetFacetInput) async throws -> GetFacetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, GetFacetOutput, GetFacetOutputError>())
    ...
    public func getLinkAttributes(input: GetLinkAttributesInput) async throws -> GetLinkAttributesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, GetLinkAttributesOutput, GetLinkAttributesOutputError>())
    ...
    public func getObjectAttributes(input: GetObjectAttributesInput) async throws -> GetObjectAttributesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, GetObjectAttributesOutput, GetObjectAttributesOutputError>())
    ...
    public func getObjectInformation(input: GetObjectInformationInput) async throws -> GetObjectInformationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, GetObjectInformationOutput, GetObjectInformationOutputError>())
    ...
    public func getSchemaAsJson(input: GetSchemaAsJsonInput) async throws -> GetSchemaAsJsonOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, GetSchemaAsJsonOutput, GetSchemaAsJsonOutputError>())
    ...
    public func getTypedLinkFacetInformation(input: GetTypedLinkFacetInformationInput) async throws -> GetTypedLinkFacetInformationOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, GetTypedLinkFacetInformationOutput, GetTypedLinkFacetInformationOutputError>())
    ...
    public func listAppliedSchemaArns(input: ListAppliedSchemaArnsInput) async throws -> ListAppliedSchemaArnsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListAppliedSchemaArnsOutput, ListAppliedSchemaArnsOutputError>())
    ...
    public func listAttachedIndices(input: ListAttachedIndicesInput) async throws -> ListAttachedIndicesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListAttachedIndicesOutput, ListAttachedIndicesOutputError>())
    ...
    public func listDevelopmentSchemaArns(input: ListDevelopmentSchemaArnsInput) async throws -> ListDevelopmentSchemaArnsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListDevelopmentSchemaArnsOutput, ListDevelopmentSchemaArnsOutputError>())
    ...
    public func listDirectories(input: ListDirectoriesInput) async throws -> ListDirectoriesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListDirectoriesOutput, ListDirectoriesOutputError>())
    ...
    public func listFacetAttributes(input: ListFacetAttributesInput) async throws -> ListFacetAttributesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListFacetAttributesOutput, ListFacetAttributesOutputError>())
    ...
    public func listFacetNames(input: ListFacetNamesInput) async throws -> ListFacetNamesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListFacetNamesOutput, ListFacetNamesOutputError>())
    ...
    public func listIncomingTypedLinks(input: ListIncomingTypedLinksInput) async throws -> ListIncomingTypedLinksOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListIncomingTypedLinksOutput, ListIncomingTypedLinksOutputError>())
    ...
    public func listIndex(input: ListIndexInput) async throws -> ListIndexOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListIndexOutput, ListIndexOutputError>())
    ...
    public func listManagedSchemaArns(input: ListManagedSchemaArnsInput) async throws -> ListManagedSchemaArnsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListManagedSchemaArnsOutput, ListManagedSchemaArnsOutputError>())
    ...
    public func listObjectAttributes(input: ListObjectAttributesInput) async throws -> ListObjectAttributesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListObjectAttributesOutput, ListObjectAttributesOutputError>())
    ...
    public func listObjectChildren(input: ListObjectChildrenInput) async throws -> ListObjectChildrenOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListObjectChildrenOutput, ListObjectChildrenOutputError>())
    ...
    public func listObjectParentPaths(input: ListObjectParentPathsInput) async throws -> ListObjectParentPathsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListObjectParentPathsOutput, ListObjectParentPathsOutputError>())
    ...
    public func listObjectParents(input: ListObjectParentsInput) async throws -> ListObjectParentsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListObjectParentsOutput, ListObjectParentsOutputError>())
    ...
    public func listObjectPolicies(input: ListObjectPoliciesInput) async throws -> ListObjectPoliciesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListObjectPoliciesOutput, ListObjectPoliciesOutputError>())
    ...
    public func listOutgoingTypedLinks(input: ListOutgoingTypedLinksInput) async throws -> ListOutgoingTypedLinksOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListOutgoingTypedLinksOutput, ListOutgoingTypedLinksOutputError>())
    ...
    public func listPolicyAttachments(input: ListPolicyAttachmentsInput) async throws -> ListPolicyAttachmentsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListPolicyAttachmentsOutput, ListPolicyAttachmentsOutputError>())
    ...
    public func listPublishedSchemaArns(input: ListPublishedSchemaArnsInput) async throws -> ListPublishedSchemaArnsOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListPublishedSchemaArnsOutput, ListPublishedSchemaArnsOutputError>())
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListTagsForResourceOutput, ListTagsForResourceOutputError>())
    ...
    public func listTypedLinkFacetAttributes(input: ListTypedLinkFacetAttributesInput) async throws -> ListTypedLinkFacetAttributesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListTypedLinkFacetAttributesOutput, ListTypedLinkFacetAttributesOutputError>())
    ...
    public func listTypedLinkFacetNames(input: ListTypedLinkFacetNamesInput) async throws -> ListTypedLinkFacetNamesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, ListTypedLinkFacetNamesOutput, ListTypedLinkFacetNamesOutputError>())
    ...
    public func lookupPolicy(input: LookupPolicyInput) async throws -> LookupPolicyOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, LookupPolicyOutput, LookupPolicyOutputError>())
    ...
    public func publishSchema(input: PublishSchemaInput) async throws -> PublishSchemaOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, PublishSchemaOutput, PublishSchemaOutputError>())
    ...
    public func putSchemaFromJson(input: PutSchemaFromJsonInput) async throws -> PutSchemaFromJsonOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, PutSchemaFromJsonOutput, PutSchemaFromJsonOutputError>())
    ...
    public func removeFacetFromObject(input: RemoveFacetFromObjectInput) async throws -> RemoveFacetFromObjectOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, RemoveFacetFromObjectOutput, RemoveFacetFromObjectOutputError>())
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, TagResourceOutput, TagResourceOutputError>())
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, UntagResourceOutput, UntagResourceOutputError>())
    ...
    public func updateFacet(input: UpdateFacetInput) async throws -> UpdateFacetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, UpdateFacetOutput, UpdateFacetOutputError>())
    ...
    public func updateLinkAttributes(input: UpdateLinkAttributesInput) async throws -> UpdateLinkAttributesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, UpdateLinkAttributesOutput, UpdateLinkAttributesOutputError>())
    ...
    public func updateObjectAttributes(input: UpdateObjectAttributesInput) async throws -> UpdateObjectAttributesOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, UpdateObjectAttributesOutput, UpdateObjectAttributesOutputError>())
    ...
    public func updateSchema(input: UpdateSchemaInput) async throws -> UpdateSchemaOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, UpdateSchemaOutput, UpdateSchemaOutputError>())
    ...
    public func updateTypedLinkFacet(input: UpdateTypedLinkFacetInput) async throws -> UpdateTypedLinkFacetOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, UpdateTypedLinkFacetOutput, UpdateTypedLinkFacetOutputError>())
    ...
    public func upgradeAppliedSchema(input: UpgradeAppliedSchemaInput) async throws -> UpgradeAppliedSchemaOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, UpgradeAppliedSchemaOutput, UpgradeAppliedSchemaOutputError>())
    ...
    public func upgradePublishedSchema(input: UpgradePublishedSchemaInput) async throws -> UpgradePublishedSchemaOutput
    {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CloudDirectoryAuthSchemeResolver, UpgradePublishedSchemaOutput, UpgradePublishedSchemaOutputError>())
