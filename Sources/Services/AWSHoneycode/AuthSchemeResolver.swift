...
public struct HoneycodeAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol HoneycodeAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service Honeycode must conform to.
}

public struct DefaultHoneycodeAuthSchemeResolver: HoneycodeAuthSchemeResolver {
    public typealias Parameters = HoneycodeAuthSchemeResolverParameters
    ...
    public func resolveAuthScheme(params: Parameters) throws -> [AuthOption] {
        ...
        switch params.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: AttributeKeys.signingName, value: "honeycode")
    ...
    public func constructParameters(context: HttpContext) throws -> Parameters {
        ...
        return HoneycodeAuthSchemeResolverParameters(operation: opName, region: opRegion)
    }
}
